...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="rdf:RDF">
        <epml:epml xmlns:epml="http://www.epml.de" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                   xsi:schemaLocation="http://www.epml.de http://wi.wu-wien.ac.at/home/mendling/EPML/EPML_12.xsd">
        ...
        <xsl:if test="$type='http://b3mn.org/stencilset/epc#Function'">
            <function>
                ...
                <xsl:if test="$execTime!=''">
                    <attribute typeRef="AT_TIME_AVG_PRCS">
                        <xsl:attribute name="value">
        ...
        <xsl:if test="$type='http://b3mn.org/stencilset/epc#Relation'">
            ...
            <relation>
                ...
                <attribute typeRef="AT_ORYX_InformationFlow">
                    <xsl:attribute name="value">
                        <xsl:value-of select="./oryx:informationflow"/>
                    </xsl:attribute>
                </attribute>
    ...
    <xsl:template name="edge-position">
        ...
        <graphics>
            <xsl:call-template name="edge-position-recursive">
                ...
                <xsl:with-param name="dockers">
                    <xsl:value-of select="./oryx:dockers"/>
                </xsl:with-param>
            </xsl:call-template>
        </graphics>
    </xsl:template>
