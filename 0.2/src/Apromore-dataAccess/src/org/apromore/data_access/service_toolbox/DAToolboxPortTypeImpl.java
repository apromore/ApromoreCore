...
import org.apromore.data_access.model_toolbox.MergedSource;
...
public class DAToolboxPortTypeImpl implements DAToolboxPortType {
	...
	public ReadProcessSummariesOutputMsgType readProcessSummaries(ReadProcessSummariesInputMsgType payload) { 
        ...
        try {        
        	...
        	org.apromore.data_access.model_toolbox.ProcessSummariesType processes = 
        		ProcessDao.getInstance().getProcessSummaries(processIds, versionNames, scores);
    ...
    public ReadCanonicalsOutputMsgType readCanonicals(ReadCanonicalsInputMsgType payload) { 
        ...
        try {
        	...
        	List<CanonicalType> allCanonicals = 
        			ProcessDao.getInstance().getCanonicals(ids,latestVersions);
