...
public class ConnectorGraphicsInfos {

    @XmlElement(name = "ConnectorGraphicsInfo")
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2010-04-22T11:04:04+10:00", comments = "JAXB RI vhudson-jaxb-ri-2.1-833")
    protected List<ConnectorGraphicsInfo> connectorGraphicsInfo;
     ...
     * {@link ConnectorGraphicsInfo }
     * 
     * 
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2010-04-22T11:04:04+10:00", comments = "JAXB RI vhudson-jaxb-ri-2.1-833")
    public List<ConnectorGraphicsInfo> getConnectorGraphicsInfo() {
        if (connectorGraphicsInfo == null) {
            connectorGraphicsInfo = new ArrayList<ConnectorGraphicsInfo>();
        }
