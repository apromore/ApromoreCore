 ...
 * generated in the de.epml package. 
...
public class ObjectFactory {
    ...
    private final static QName _Epml_QNAME = new QName("http://www.epml.de", "epml");
    ...
    private final static QName _TypeEPCProcessInterface_QNAME = new QName("", "processInterface");
    private final static QName _TypeEPCConfigurationGuideline_QNAME = new QName("", "configurationGuideline");
    ...
    private final static QName _TypeEPCFunction_QNAME = new QName("", "function");
    private final static QName _TypeEPCArc_QNAME = new QName("", "arc");
    private final static QName _TypeEPCEvent_QNAME = new QName("", "event");
    private final static QName _TypeEPCConfigurationRequirement_QNAME = new QName("", "configurationRequirement");
    private final static QName _TypeEPCRole_QNAME = new QName("", "role");
    private final static QName _TypeEPCConfigurationOrder_QNAME = new QName("", "configurationOrder");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.epml
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TypeEPML }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.epml.de", name = "epml")
    public JAXBElement<TypeEPML> createEpml(TypeEPML value) {
        return new JAXBElement<TypeEPML>(_Epml_QNAME, TypeEPML.class, null, value);
    }
    ...
    public JAXBElement<TypeXOR> createTypeEPCXor(TypeXOR value) {
        return new JAXBElement<TypeXOR>(_TypeEPCXor_QNAME, TypeXOR.class, TypeEPC.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TypeRANGE }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "range", scope = TypeEPC.class)
    public JAXBElement<TypeRANGE> createTypeEPCRange(TypeRANGE value) {
        return new JAXBElement<TypeRANGE>(_TypeEPCRange_QNAME, TypeRANGE.class, TypeEPC.class, value);
    }
    ...
    public JAXBElement<TypeOR> createTypeEPCOr(TypeOR value) {
        return new JAXBElement<TypeOR>(_TypeEPCOr_QNAME, TypeOR.class, TypeEPC.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TypeProcessInterface }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "processInterface", scope = TypeEPC.class)
    public JAXBElement<TypeProcessInterface> createTypeEPCProcessInterface(TypeProcessInterface value) {
        return new JAXBElement<TypeProcessInterface>(_TypeEPCProcessInterface_QNAME, TypeProcessInterface.class, TypeEPC.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TypeCReq }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "configurationGuideline", scope = TypeEPC.class)
    public JAXBElement<TypeCReq> createTypeEPCConfigurationGuideline(TypeCReq value) {
        return new JAXBElement<TypeCReq>(_TypeEPCConfigurationGuideline_QNAME, TypeCReq.class, TypeEPC.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TypeObject }{@code >}}
     * 
     */
    ...
    public JAXBElement<TypeObject> createTypeEPCObject(TypeObject value) {
        return new JAXBElement<TypeObject>(_TypeEPCObject_QNAME, TypeObject.class, TypeEPC.class, value);
    }
    ...
    public JAXBElement<TypeAND> createTypeEPCAnd(TypeAND value) {
        return new JAXBElement<TypeAND>(_TypeEPCAnd_QNAME, TypeAND.class, TypeEPC.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TypeFunction }{@code >}}
     * 
     */
    ...
    public JAXBElement<TypeFunction> createTypeEPCFunction(TypeFunction value) {
        return new JAXBElement<TypeFunction>(_TypeEPCFunction_QNAME, TypeFunction.class, TypeEPC.class, value);
    }
    ...
    public JAXBElement<TypeArc> createTypeEPCArc(TypeArc value) {
        return new JAXBElement<TypeArc>(_TypeEPCArc_QNAME, TypeArc.class, TypeEPC.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TypeEvent }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "event", scope = TypeEPC.class)
    public JAXBElement<TypeEvent> createTypeEPCEvent(TypeEvent value) {
        return new JAXBElement<TypeEvent>(_TypeEPCEvent_QNAME, TypeEvent.class, TypeEPC.class, value);
    }
    ...
    public JAXBElement<TypeCReq> createTypeEPCConfigurationRequirement(TypeCReq value) {
        return new JAXBElement<TypeCReq>(_TypeEPCConfigurationRequirement_QNAME, TypeCReq.class, TypeEPC.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TypeRole }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "role", scope = TypeEPC.class)
    public JAXBElement<TypeRole> createTypeEPCRole(TypeRole value) {
        return new JAXBElement<TypeRole>(_TypeEPCRole_QNAME, TypeRole.class, TypeEPC.class, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link TypeCOrder }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "configurationOrder", scope = TypeEPC.class)
    public JAXBElement<TypeCOrder> createTypeEPCConfigurationOrder(TypeCOrder value) {
        return new JAXBElement<TypeCOrder>(_TypeEPCConfigurationOrder_QNAME, TypeCOrder.class, TypeEPC.class, value);
    }
