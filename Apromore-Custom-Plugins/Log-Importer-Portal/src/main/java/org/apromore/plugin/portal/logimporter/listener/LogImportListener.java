 ...
 * #L%
 */
package org.apromore.plugin.portal.logimporter.listener;
 ...
 *
 */
public class LogImportListener implements EventListener<Event> {

    private static Logger logger = PortalLoggerFactory.getLogger(LogImportListener.class);
     ...
     *                          calling class.
     */
    public LogImportListener(Map args, String target, Component componentToDetach, JSONObject json) {
	super();
	this.args = args;
	...
	default:
	    ...
	    try {
		Window window = (Window) PortalContextHolder.getActivePortalContext().getUI()
