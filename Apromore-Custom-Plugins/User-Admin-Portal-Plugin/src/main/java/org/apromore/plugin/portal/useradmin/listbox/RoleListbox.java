...
public class RoleListbox extends SearchableListbox {

    public RoleListbox(Listbox listbox, ListModelList<RoleModel> sourceListModel, String title) {
        super(listbox, sourceListModel, title);
    }

    @Override
    public String getValue(int index) {
        return ((RoleModel) this.getSourceListModel().get(index)).getLabel().toLowerCase();
    }
