...
public class Calculator_OLD {
	...
	public static void main (String[] args) {
		Calculator_OLD cal = new Calculator_OLD();
		cal.setCurrentDate(Long.toString(System.currentTimeMillis()));
		
		System.out.println(cal.getCurrentDate());
		
		cal.method10(cal.getCurrentDate(), 1000, 1);
		System.out.println(cal.method6());
		
		cal.method10(cal.getCurrentDate(), 1001, 1);
		System.out.println(cal.method6());
		
		cal.method10(cal.getCurrentDate(), 1002, 1);
		System.out.println(cal.method6());
		//System.out.println(cal.method14(4, 100));
	}

    private BitSet var1;
    private String currentDate; //current system date yyyymmdd
    ...
    public void setCurrentDate(String var11) {
        ...
        for(int i = 1; i < 6; i++) { // 1: YEAR, 2: MONTH (based 0), 3: WEEK_OF_YEAR, 4: WEEK_OF_MONTH, 5: DAY_OF_MONTH (based 1)
            ...
            if(i == 1) currentDate += cal.get(i);
                ...
                currentDate += Integer.toString(cal.get(i));
            }else {
                j += i;
            }
        }
    ...
    // var14: increment
    public void method10(String seed, long current, long increment) {
        method18(seed);
        method14(increment, current);
    }
