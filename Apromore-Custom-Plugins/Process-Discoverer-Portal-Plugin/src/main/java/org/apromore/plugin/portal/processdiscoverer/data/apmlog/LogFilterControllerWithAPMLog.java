...
package org.apromore.plugin.portal.processdiscoverer.data.apmlog;
...
/**
 * LogFilterControllerWithAPMLog is LogFilterController but uses APMLog to do filtering.
 * 
 * @author Bruce Nguyen
 *
 */
public class LogFilterControllerWithAPMLog extends LogFilterController implements LogFilterResultListener {
    ...
    public LogFilterControllerWithAPMLog(PDController controller) {
        super(controller);
