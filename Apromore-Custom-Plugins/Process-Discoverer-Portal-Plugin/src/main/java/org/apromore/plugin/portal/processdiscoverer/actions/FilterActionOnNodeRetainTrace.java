...
public class FilterActionOnNodeRetainTrace extends FilterActionOnElementFilter {
    ...
    public boolean performFiltering(String elementValue, String attributeKey) throws Exception {
        return analyst.filter_RetainTracesAnyValueOfEventAttribute(elementValue, attributeKey);
    }
