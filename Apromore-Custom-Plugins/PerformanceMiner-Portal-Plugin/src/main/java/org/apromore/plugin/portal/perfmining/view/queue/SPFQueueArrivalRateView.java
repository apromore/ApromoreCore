...
public class SPFQueueArrivalRateView extends SPFView {
	public SPFQueueArrivalRateView(SPF bpf, String stageName, String subStageName, String viewName, boolean isCategory) {
