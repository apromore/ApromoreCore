...
public interface LogProcessor {
    ...
    LogEventModel processLog(List<String> line, List<String> header, LogSample sample, int lineIndex, List<LogErrorReport> logErrorReport, Parse parse, boolean validRow);
}
