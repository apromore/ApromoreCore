...
//    private static final String TIME_ZONE = "(Z|[+-](?:2[0-3]|[01][0-9])(?::?(?:[0-5][0-9]))?)";
    ...
    static {
        ...
        DATE_FORMAT_REGEXPS.put("^" + DATE_NO_SPACE_YEAR_MONTH_DAY + TIME_NO_SPACE_SECOND + "\\d{1}" + "$", "yyyyMMddHHmmssS");
        DATE_FORMAT_REGEXPS.put("^" + DATE_NO_SPACE_YEAR_MONTH_DAY + "\\s+" + TIME_NO_SPACE_SECOND + "\\d{1}" + "$", "yyyyMMdd HHmmssS");
        DATE_FORMAT_REGEXPS.put("^" + DATE_DASH_DAY_MONTH_YEAR + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "dd-MM-yyyy HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_DASH_MONTH_DAY_YEAR + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "MM-dd-yyyy HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_DASH_YEAR_MONTH_DAY + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "yyyy-MM-dd HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "\\s+" + DATE_DASH_YEAR_MONTH_DAY + "$", "HH:mm:ss.S yyyy-MM-dd");
        DATE_FORMAT_REGEXPS.put("^" + DATE_DASH_YEAR_DAY_MONTH + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "yyyy-dd-MM HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_DASH_DAY_MONTH_YEAR + "t" + "{1}" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "dd-MM-yyyy'T'HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_DASH_MONTH_DAY_YEAR + "t" + "{1}" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "MM-dd-yyyy'T'HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_DASH_YEAR_MONTH_DAY + "t" + "{1}" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "yyyy-MM-dd'T'HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_DASH_YEAR_DAY_MONTH + "t" + "{1}" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "yyyy-dd-MM'T'HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SLASH_DAY_MONTH_YEAR + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "dd/MM/yyyy HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SLASH_MONTH_DAY_YEAR + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "MM/dd/yyyy HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SLASH_YEAR_MONTH_DAY + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "yyyy/MM/dd HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SLASH_YEAR_DAY_MONTH + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "yyyy/dd/MM HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SPACE_DAY_MONTH_YEAR + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "dd MM yyyy HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SPACE_MONTH_DAY_YEAR + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "MM dd yyyy HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SPACE_YEAR_MONTH_DAY + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "yyyy MM dd HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SPACE_YEAR_DAY_MONTH + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "yyyy dd MM HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SPACE_DAY_MONTH_YEAR + "\\s+" + TIME_SPACE_SECOND + "\\s+" + "\\d{1}" + "$", "dd MM yyyy HH mm ss S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SPACE_MONTH_DAY_YEAR + "\\s+" + TIME_SPACE_SECOND + "\\s+" + "\\d{1}" + "$", "MM dd yyyy HH mm ss S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SPACE_YEAR_MONTH_DAY + "\\s+" + TIME_SPACE_SECOND + "\\s+" + "\\d{1}" + "$", "yyyy MM dd HH mm ss S");
        DATE_FORMAT_REGEXPS.put("^" + DATE_SPACE_YEAR_DAY_MONTH + "\\s+" + TIME_SPACE_SECOND + "\\s+" + "\\d{1}" + "$", "yyyy dd MM HH mm ss S");
        DATE_FORMAT_REGEXPS.put("^" + DAY_DIGIT + "{1}" + "\\s+" + MONTH_NAME_SHORT + "{1}" + "\\s+" + YEAR_DIGIT + "{1}" + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "dd MMM yyyy HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DAY_DIGIT + "{1}" + "\\s+" + MONTH_NAME_LONG + "{1}" + "\\s+" + YEAR_DIGIT + "{1}" + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "dd MMMM yyyy HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + MONTH_NAME_SHORT + "{1}" + "\\s+" + DAY_DIGIT + "{1}" + "\\s+" + YEAR_DIGIT + "{1}" + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "MMM dd yyyy HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + MONTH_NAME_LONG + "{1}" + "\\s+" + DAY_DIGIT + "{1}" + "\\s+" + YEAR_DIGIT + "{1}" + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "MMMM dd yyyy HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + YEAR_DIGIT + "{1}" + "\\s+" + MONTH_NAME_SHORT + "{1}" + "\\s+" + DAY_DIGIT + "{1}" + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "yyyy MMM dd HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + YEAR_DIGIT + "{1}" + "\\s+" + MONTH_NAME_LONG + "{1}" + "\\s+" + DAY_DIGIT + "{1}" + "\\s+" + TIME_COLON_SECOND + "\\." + "\\d{1}" + "$", "yyyy MMMM dd HH:mm:ss.S");
        DATE_FORMAT_REGEXPS.put("^" + DAY_DIGIT + "{1}" + "\\s+" + MONTH_NAME_SHORT + "{1}" + "\\s+" + YEAR_DIGIT + "{1}" + "\\s+" + TIME_SPACE_SECOND + "\\s+" + "\\d{1}" + "$", "dd MMM yyyy HH mm ss S");
        DATE_FORMAT_REGEXPS.put("^" + DAY_DIGIT + "{1}" + "\\s+" + MONTH_NAME_LONG + "{1}" + "\\s+" + YEAR_DIGIT + "{1}" + "\\s+" + TIME_SPACE_SECOND + "\\s+" + "\\d{1}" + "$", "dd MMMM yyyy HH mm ss S");
        DATE_FORMAT_REGEXPS.put("^" + MONTH_NAME_SHORT + "{1}" + "\\s+" + DAY_DIGIT + "{1}" + "\\s+" + YEAR_DIGIT + "{1}" + "\\s+" + TIME_SPACE_SECOND + "\\s+" + "\\d{1}" + "$", "MMM dd yyyy HH mm ss S");
        DATE_FORMAT_REGEXPS.put("^" + MONTH_NAME_LONG + "{1}" + "\\s+" + DAY_DIGIT + "{1}" + "\\s+" + YEAR_DIGIT + "{1}" + "\\s+" + TIME_SPACE_SECOND + "\\s+" + "\\d{1}" + "$", "MMMM dd yyyy HH mm ss S");
        DATE_FORMAT_REGEXPS.put("^" + YEAR_DIGIT + "{1}" + "\\s+" + MONTH_NAME_SHORT + "{1}" + "\\s+" + DAY_DIGIT + "{1}" + "\\s+" + TIME_SPACE_SECOND + "\\s+" + "\\d{1}" + "$", "yyyy MMM dd HH mm ss S");
        DATE_FORMAT_REGEXPS.put("^" + YEAR_DIGIT + "{1}" + "\\s+" + MONTH_NAME_LONG + "{1}" + "\\s+" + DAY_DIGIT + "{1}" + "\\s+" + TIME_SPACE_SECOND + "\\s+" + "\\d{1}" + "$", "yyyy MMMM dd HH mm ss S");
