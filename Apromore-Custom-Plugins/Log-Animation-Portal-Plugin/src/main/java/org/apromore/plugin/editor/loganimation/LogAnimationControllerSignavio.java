 ...
 */
public class LogAnimationControllerSignavio extends BaseController {

    private static final Logger LOGGER = LoggerFactory.getLogger(LogAnimationControllerSignavio.class.getCanonicalName());
    ...
    public LogAnimationControllerSignavio() {
        super();
        ...
        try {
            ...
            List<EditorPlugin> editorPlugins = EditorPluginResolver.resolve("editorPluginsSignavio");
