...
/**
 * This class is used to collect duration statistics of event relations
 * from logs based on a chosen attribute selected as an event classifier.
 * 
 * @author Bruce Nguyen
 *
 */
public abstract class RelationDurationStats extends StatsCollector {
	protected XLog log;
    ...
    public void startVisit(LogManager logManager) {
    	...
    	attribute = attributeStore.getAttribute(classifier.getAttribute(), AttributeLevel.EVENT);
    	relationLog.clear();
    }
