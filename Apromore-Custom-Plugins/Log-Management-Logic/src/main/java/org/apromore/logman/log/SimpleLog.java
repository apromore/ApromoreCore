...
public class SimpleLog extends ArrayList<IntList> {
    ...
    public SimpleLog(SimpleLog log, IntHashSet retained_activities) throws Exception {
    	super(log.size());
...
//    }
    ...
    public SimpleLog filterActivities(IntHashSet retained_activities) throws Exception {
    	return new SimpleLog(this, retained_activities);
    }
