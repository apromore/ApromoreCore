...
public class TimeRange {
    ...
    @Getter @Setter private Date start; // needed for timebox
    @Getter @Setter private Date end; // needed for timebox

    @Getter @Setter private OffsetTime startTime;
    @Getter @Setter private OffsetTime endTime;
