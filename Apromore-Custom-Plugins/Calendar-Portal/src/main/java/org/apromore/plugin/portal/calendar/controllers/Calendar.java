...
public class Calendar extends SelectorComposer<Window> {
	...
	if (calendarExists) {
		...
		calendarService.updateHoliday(calendarId, (List<HolidayModel>) holidayListbox.getModel());
	...
	// holidayListModel.add(new HolidayItem(LocalDate.parse("2020-12-25"),
	// "Christmas"));
	// holidayListModel.add(new HolidayItem(LocalDate.parse("2020-01-01"), "New Year
	// Day"));
    }
