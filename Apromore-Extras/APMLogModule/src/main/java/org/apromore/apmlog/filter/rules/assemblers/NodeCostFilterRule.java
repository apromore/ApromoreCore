...
@UtilityClass
public class NodeCostFilterRule {
    public static LogFilterRule of(boolean retain,
                                                boolean includeAll,
                                                String nodeName,
                                                String nodeValue,
                                                CostOptions costOptions) {
        FilterType filterType = FilterType.NODE_COST;
        double minCost = costOptions.getMinCost();
        double maxCost = costOptions.getMaxCost();
        RuleValue rvMin = new RuleValue(filterType, OperationType.GREATER_EQUAL, nodeValue, minCost);
        RuleValue rvMax = new RuleValue(filterType, OperationType.LESS_EQUAL, nodeValue, maxCost);
