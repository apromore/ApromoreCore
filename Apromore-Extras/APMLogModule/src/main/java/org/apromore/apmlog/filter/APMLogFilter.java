...
import org.apromore.apmlog.filter.criterion.APMLogFilterCriterion;
...
//        System.out.println("");
    ...
    public void filter(List<LogFilterCriterion> criteria) {
        ...
        if(criteria != null) {
            ...
            for(int i=0; i<criteria.size(); i++) {
                ...
                APMLogFilterCriterion criterionEE = new APMLogFilterCriterion(criterion);

                switch (criterionEE.section) {
                    case EVENT:
