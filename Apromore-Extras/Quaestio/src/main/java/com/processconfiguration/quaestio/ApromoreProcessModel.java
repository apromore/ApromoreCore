...
class ApromoreProcessModel implements ProcessModel {
	 ...
	 * @param versionString       the version number of the process model
         ...
         */
	ApromoreProcessModel(final URI managerEndpointURI, final int processId, String branch, String versionString, final Component parent, final String user) throws Exception {
