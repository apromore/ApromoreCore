...
public class QuestionTypeListModel extends AbstractListModel
{
    public Vector<QuestionType> delegate = new Vector<QuestionType>();

    public QuestionTypeListModel(){
    	super();
    }    
    
    public QuestionTypeListModel(Vector<QuestionType> vIn){
    	super();
    	delegate=new Vector<QuestionType>(vIn);
    }
     ...
     * @see #get(int)
     */
    public QuestionType getElementAt(int index) {
     ...
     */
    public boolean contains(QuestionType elem) {
    	for (QuestionType iterable : delegate) {
			if (elem.getId().equals(iterable.getId()))
					return true;
		}
    	return false;
    }
     ...
     */
    public int indexOf(QuestionType elem) {
     ...
     */
     public int indexOf(QuestionType elem, int index) {
     ...
     */
    public int lastIndexOf(QuestionType elem) {
     ...
     */
    public int lastIndexOf(QuestionType elem, int index) {
     ...
     */
    public QuestionType elementAt(int index) {
	return delegate.elementAt(index);
    }
     ...
     */
    public QuestionType firstElement() {
     ...
     */
    public QuestionType lastElement() {
     ...
     */
    public void setElementAt(QuestionType obj, int index) {
     ...
     */
    public void insertElementAt(QuestionType obj, int index) {
     ...
     */
    public void addElement(QuestionType obj) {
     ...
     */
    public boolean removeElement(QuestionType obj) {
    	boolean rv=false; int index =-1;
    	for (QuestionType iterable : delegate) {
			if (obj.getId().equals(iterable.getId())){
				index = delegate.indexOf(iterable);
				break;
			}
		}
	if (index >= 0) {
   ...
   public String toString() {
    ...
    QuestionType[] rv = new QuestionType[delegate.size()];
     ...
     */
    public QuestionType set(int index, QuestionType element) {
    QuestionType rv = delegate.elementAt(index);
     ...
     */
    public void add(int index, QuestionType element) {
     ...
     */
    public QuestionType remove(int index) {
    QuestionType rv = delegate.elementAt(index);
	delegate.removeElementAt(index);
	fireIntervalRemoved(this, index, index);
	return rv;
