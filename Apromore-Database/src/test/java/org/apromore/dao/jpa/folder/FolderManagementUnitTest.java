...
@Transactional
class FolderManagementUnitTest extends BaseTestClass {
    ...
    @Test
    void testCountFolderWith2Folders() {
        //	Given
    ...
    @Test
    void testCountFolderWith2FoldersWithChain() {
        //	Given
        Folder folder1 = new Folder();
        folder1.setName("folder1");
    ...
    @Test
    void testCountFolderWith2FoldersWithChain1() {
        //	Given
        Folder folder1 = new Folder();
        folder1.setName("folder1");
    ...
    @Test
    void testFindFoldersByRootParent() {
        //	Given
        Folder folder1 = new Folder();
        folder1.setName("folder1");
