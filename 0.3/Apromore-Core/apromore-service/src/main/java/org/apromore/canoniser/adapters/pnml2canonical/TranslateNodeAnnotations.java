		...
		if (element.getGraphics() != null) {
			if (element.getName() != null) {
				if (element.getName().getGraphics() != null) {
					...
					List<Object> agt = element.getName().getGraphics()
							.getOffsetAndFillAndLine();
					for (Object oaf : agt) {
						...
						if (oaf instanceof Fill) {
							...
							if (((Fill) oaf).getGradientColor() != null) {
								fill.setGradientColor(((Fill) oaf)
										.getGradientColor());
							}
							if (((Fill) oaf).getGradientRotation() != null) {
								fill.setGradientRotation(((Fill) oaf)
										.getGradientRotation());
							}
							graphT.setFill(fill);
						}
							...
							if (((org.apromore.pnml.Font) oaf).getFamily() != null) {
								font.setFamily(((org.apromore.pnml.Font) oaf)
										.getFamily());
							}
							if (((org.apromore.pnml.Font) oaf).getStyle() != null) {
								font.setStyle(((org.apromore.pnml.Font) oaf)
										.getStyle());
							}
							if (((org.apromore.pnml.Font) oaf).getWeight() != null) {
								font.setWeight(((org.apromore.pnml.Font) oaf)
										.getWeight());
							}
							if (((org.apromore.pnml.Font) oaf).getSize() != null) {
								font.setSize(BigInteger.valueOf(Long
										.valueOf(((org.apromore.pnml.Font) oaf)
												.getSize())));
							}
							if (((org.apromore.pnml.Font) oaf).getDecoration() != null) {
								font.setDecoration(((org.apromore.pnml.Font) oaf)
										.getDecoration());
							}
							if (((org.apromore.pnml.Font) oaf).getRotation() != null) {
								font.setRotation(((org.apromore.pnml.Font) oaf)
										.getRotation());
							}
							graphT.setFont(font);
							...
							if (((org.apromore.pnml.PositionType) oaf).getX() != null) {
								font.setXPosition(((org.apromore.pnml.PositionType) oaf)
										.getX());
							}
							if (((org.apromore.pnml.PositionType) oaf).getY() != null) {
								font.setYPosition(((org.apromore.pnml.PositionType) oaf)
										.getY());
							}
							graphT.setFont(font);
						}
			...
			graphT.setCpfId(BigInteger.valueOf(Long.valueOf(cpfId)));
		...
		if (element instanceof PlaceType) {
			...
			if (((PlaceType) element).getInitialMarking() != null) {
				if (((PlaceType) element).getInitialMarking().getText() != null) {
					...
					simu.setInitialMarking(((PlaceType) element)
