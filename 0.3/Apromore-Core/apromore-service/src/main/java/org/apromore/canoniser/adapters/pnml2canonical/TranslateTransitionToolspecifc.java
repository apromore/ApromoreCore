...
public class TranslateTransitionToolspecifc {
	...
	public void translate(Object obj) {
		...
		List<TransitionToolspecificType> pnmlTransitionToolspecific = element
				.getToolspecific();
		...
		if (element.getToolspecific() != null) {
			...
			for (Object obj2 : pnmlTransitionToolspecific) {
				if (obj2 instanceof TransitionToolspecificType) {
					...
					if (transitionToolspecific.getTransitionResource() != null) {
						if (transitionToolspecific.getTransitionResource()
								.getOrganizationalUnitName() != null) {
							if (!units
									.containsKey(((OrganizationUnitType) transitionToolspecific
								...
								units.put(
										((OrganizationUnitType) transitionToolspecific
												...
												+ ((RoleType) transitionToolspecific
														...
														.getRoleName())
														.getName(), String
												.valueOf(data.getResourceID()));
								ResourceTypeType roleunit = new ResourceTypeType();
								resid = data.getResourceID();
								roleunit.setId(BigInteger.valueOf(resid++));
								data.setResourceID(resid);
								roleunit.setName(((OrganizationUnitType) transitionToolspecific
										.getTransitionResource()
							...
							if (test != null) {
								...
								rtrunit.setResourceTypeId(BigInteger.valueOf(Long.valueOf(units.get(((OrganizationUnitType) transitionToolspecific
										.getTransitionResource()
										.getOrganizationalUnitName()).getName()
										+ "-"
										+ ((RoleType) transitionToolspecific
												.getTransitionResource()
												.getRoleName()).getName()))));
								((WorkType) test).getResourceTypeRef().add(
										rtrunit);
					...
					if (transitionToolspecific.getTime() != null) {
						...
						simu.setTime(BigInteger.valueOf(Long
								.valueOf(transitionToolspecific.getTime())));
						countsimu++;
					}
					if (transitionToolspecific.getTimeUnit() != null) {

						simu.setTimeUnit(BigInteger.valueOf(Long
								.valueOf(transitionToolspecific.getTimeUnit())));
						countsimu++;
					}
			...
			if (countsimu != 0) {
				...
				simu.setCpfId(BigInteger.valueOf(Long.valueOf(cpfId)));
