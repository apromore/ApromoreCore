 ...
 */
@Endpoint
public class PortalOryxEndpoint {

    private static final Logger LOGGER = LoggerFactory.getLogger(PortalOryxEndpoint.class.getName());

    private static final String NAMESPACE = "http://www.apromore.org/portal/model_oryx";

    @Autowired
    ManagerService mgr;


    @PayloadRoot(namespace = NAMESPACE, localPart = "WriteNewAnnotationInputMsg")
    @ResponsePayload
    public JAXBElement<WriteNewAnnotationOutputMsgType> writeNewAnnotation(@RequestPayload JAXBElement<WriteNewAnnotationInputMsgType> req) {
    ...
    @PayloadRoot(namespace = NAMESPACE, localPart = "WriteAnnotationInputMsg")
    @ResponsePayload
    ...
    @PayloadRoot(namespace = NAMESPACE, localPart = "WriteProcessInputMsg")
    @ResponsePayload
...
//            result.setMessage(ex.getMessage());
    ...
    @PayloadRoot(namespace = NAMESPACE, localPart = "WriteNewProcessInputMsg")
    @ResponsePayload
    ...
    @PayloadRoot(namespace = NAMESPACE, localPart = "ReadNativeInputMsg")
    @ResponsePayload
