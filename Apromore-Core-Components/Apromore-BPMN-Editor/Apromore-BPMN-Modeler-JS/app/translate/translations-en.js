module.exports = {
  ...
  'attachments.image.src': 'Image source URL',
  'attachments.image.upload': 'Image upload',
  'attachments.image.remove': 'Remove',
  'attachments.image.link': 'Link for image',
  'attachments.image.text': 'Text for image',
  'attachments.icon.list': 'Icon List',
  'attachments.icon.list.add.label': 'Add new',
  'attachments.icon.list.remove.label': 'Remove',
  ...
  'general.categorical.case.attribute.prefix' : 'Case attribute ',
  ...
  'general.caseAttribute.categorical.label':'Categorical',
  'general.caseAttribute.numerical.label':'Numerical',
  'gateway.probability.label':'Probability',
  'gateway.condition.label':'Condition',
  ...
  'gateway.expression.clause.prefix':'Clause ',
  'gateway.expression.operator.label':'Operator',
  'gateway.expression.operator.equal.label':'Equal to (=)',
  'gateway.expression.operator.notEqual.label':'Not equal to (≠)',
  ...
  'subprocess.link.label' : 'Linked subprocess:',
  'subprocess.link.edit.label' : 'Edit',
  'subprocess.link.unlink.label' : 'Unlink',
};