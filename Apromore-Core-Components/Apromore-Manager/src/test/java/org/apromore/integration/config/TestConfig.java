...
import org.apromore.apmlog.config.APMLogConfig;
import org.apromore.apmlog.impl.APMLogServiceImpl;
import org.apromore.cache.CacheConfig;
import org.apromore.config.ManagerConfig;
...
import org.apromore.storage.config.StorageConfig;
...
@TestPropertySource(value = { "classpath:application.properties", "classpath:integration-test/cache-config.properties",
