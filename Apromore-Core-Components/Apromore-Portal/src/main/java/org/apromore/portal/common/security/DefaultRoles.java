...
package org.apromore.portal.common.security;

import java.util.HashMap;
import java.util.Map;
import org.apromore.zk.label.LabelSupplier;

public class DefaultRoles implements LabelSupplier {
    ...
    public Map<String, String> getRoles() {
        return instance.roleMap;
    }

    public String getRoleDisplayByName(String roleName) {
        return instance.roleMap.get(roleName) == null ? roleName : instance.roleMap.get(roleName);
    }
