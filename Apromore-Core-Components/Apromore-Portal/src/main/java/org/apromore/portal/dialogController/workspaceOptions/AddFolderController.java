...
public class AddFolderController extends BaseController {
  ...
  public AddFolderController(MainController mainController, User currentUser,
      FolderType currentFolder) throws DialogException {
    ...
    try {
      final Window win =
          (Window) Executions.createComponents("~./macros/folderCreate.zul", null, null);
  ...
  private void save() throws InterruptedException {
    try {
      ...
      this.mainController.getManagerService().createFolder(userId, folderName,
