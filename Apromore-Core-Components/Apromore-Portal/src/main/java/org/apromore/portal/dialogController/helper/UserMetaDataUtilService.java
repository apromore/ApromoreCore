package org.apromore.portal.dialogController.helper;
...
public class UserMetaDataUtilService {
    ...
    private List<UserMetadataSummaryType> getUserMetadataSummaries(Integer logId,
        ...
        Set<Usermetadata> filterUmSet = null;
        try {
            filterUmSet =
                userMetadataService.getUserMetadata(user.getUsername(), Collections.singletonList(logId),
