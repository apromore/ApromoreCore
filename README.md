...
* Run the ant command to install, configure and start Eclipse Virgo, and deploy Apromore:
   - `ant start-virgo` (only available on Windows platforms) to start all plugins   
   - `ant start-virgo-nix` to start only core Apromore plugins
