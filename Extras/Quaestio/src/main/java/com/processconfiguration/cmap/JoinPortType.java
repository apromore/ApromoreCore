...
/**
 * <p>
 * Java class for joinPortType complex type.
 * 
 * <p>
...
@XmlType(name = "joinPortType", propOrder = { "value" })
public class JoinPortType {

	@XmlElement(required = true)
	protected List<JoinPortType.Value> value;
	@XmlAttribute
	 ...
	 * {@link JoinPortType.Value }
	 * 
	 * 
	 */
	public List<JoinPortType.Value> getValue() {
		if (value == null) {
			value = new ArrayList<JoinPortType.Value>();
		}
		return this.value;
	}
