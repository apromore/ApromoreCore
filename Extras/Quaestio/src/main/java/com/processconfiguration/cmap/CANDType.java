...
/**
 * <p>
 * Java class for CANDType complex type.
 * 
 * <p>
...
@XmlType(name = "CANDType", propOrder = { "value" })
public class CANDType {

	@XmlElement(required = true)
	protected List<CANDType.Value> value;
	 ...
	 * 
	 */
	public List<CANDType.Value> getValue() {
		if (value == null) {
			value = new ArrayList<CANDType.Value>();
		}
		return this.value;
	}
