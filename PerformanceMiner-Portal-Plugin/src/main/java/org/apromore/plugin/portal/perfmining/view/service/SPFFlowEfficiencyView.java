...
public class SPFFlowEfficiencyView extends SPFView {
	public SPFFlowEfficiencyView(SPF bpf, String stageName, String subStageName, String viewName, boolean isCategory) {
