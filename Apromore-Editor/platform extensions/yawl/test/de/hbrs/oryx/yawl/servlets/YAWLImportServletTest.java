...
public class YAWLImportServletTest {
	...
	public void testGetJsonFromYAWL() throws YSyntaxException, JSONException, JDOMException, IOException {
		...
		JSONObject orderFulfillment = importServlet.getJsonFromYAWL(YAWLTestData.orderFulfillmentSource);
	...
	/**
	 * This test prepares a request that can be used to test YAWLExportServlet!
	 * If you make any changes to the import of a YAWL specification, you
	 * probably want to copy the generated file 'orderfulfillment.json' to the
	 * '/resources/' directory and overwrite the old test fixture.
	 * 
	...
	public void prepareExportRequestData() throws YSyntaxException, JSONException, JDOMException, IOException {
		JSONObject orderFulfillment = new YAWLImportServlet().getJsonFromYAWL(YAWLTestData.orderFulfillmentSource);
		writeRequestData(orderFulfillment, "orderfulfilment.json");

		JSONObject filmProduction = new YAWLImportServlet().getJsonFromYAWL(YAWLTestData.filmProduction);
		writeRequestData(filmProduction, "filmproduction.json");
	}

	private void writeRequestData(JSONObject jsonResult, String fileName) throws JSONException, IOException {
