...
public class YAWLConverter {
     ...
     * specification.
     *
     * @param rootDir of the editor appplication used to retrieve Stencil Set
     */
     ...
     * OryxResult object.
     *
     * @param specification of the YAWL file
     * @throws YSyntaxException in case of invalid YAWL syntax
     * @throws JDOMException    in case of an error converting the layout
     * @throws IOException      in case of an error converting the layout
     */
     ...
     *
     * @param specification
     * @throws YSyntaxException in case of an invalid specification
     */
     ...
     *
     * @param jsonData of an YAWL diagram from Oryx
