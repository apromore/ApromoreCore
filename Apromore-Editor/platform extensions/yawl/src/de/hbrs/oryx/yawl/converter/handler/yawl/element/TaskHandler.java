...
public abstract class TaskHandler extends NetElementHandler {
     ...
     *
     * @param context
     * @param netElement    the YAWL Task
     * @param taskType      defines the StencilId that is created
     * @param decomposition
     */
    public TaskHandler(YAWLConversionContext context, YNetElement netElement, String taskType, YDecomposition decomposition) {
     ...
     *
     * @param layout of the YAWL task read from layout XML
    ...
    protected HashMap<String, String> convertTaskProperties(NetElementLayout layout) {
        ...
        if (iconPath != null && !iconPath.isEmpty()) {
            ...
            properties.put("icon", filename.substring(0, filename.length() - 4).toLowerCase());
        }
    ...
    /**
     * Does sort the Flows with built-in Java Collections.sort. As JDOM does not
     * use generics, it is unchecked!
     */
    ...
    private String convertConnectorType(int splitType, DecoratorType splitDecorator) {
