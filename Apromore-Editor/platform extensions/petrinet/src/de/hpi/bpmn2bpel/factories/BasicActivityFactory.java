...
public class BasicActivityFactory {
	 ...
	 * {@link de.hpi.bpmn2bpel.factories.SupportingFactory#createFromSpecElement(model.supporting.FromSpec)} and
	 * {@link de.hpi.bpmn2bpel.factories.SupportingFactory#createToSpecElement(model.supporting.ToSpec)}.
	 * 
...
//			this.output.addError("The assign task has a copy without a specified to spec element.", task.getId());
	 ...
	 * are generated using the appropriate methods
	 * {@link de.hpi.bpmn2bpel.factories.SupportingFactory#createCorrelationsElement(java.util.List)} and
	 * {@link de.hpi.bpmn2bpel.factories.SupportingFactory#createFromPartsElement(java.util.List)}.
	 * </p>
	 * 
	 * <p>
...
//		BPELUtil.setStandardAttributes(result, event);
	 ...
	 * {@link #createReceiveElement(de.hpi.bpel4chor.model.activities.Event, de.hpi.bpel4chor.model.activities.Trigger, boolean)}</p>
	 * 
...
//		return createScopeForAttachedHandlers(result, task);
	...
	/**
	 * Creates a raw BPEL invoke element from a {@link de.hpi.bpmn.Task} in the first
	 * implentation.
	 * 
	 * @param task
	 * 		The {@link de.hpi.bpmn.Task} object representing the invoke
	 * @return
	 ...
	 * are generated using the appropriate methods
	 * {@link de.hpi.bpmn2bpel.factories.SupportingFactory#createCorrelationsElement(java.util.List)},
	 * {@link de.hpi.bpmn2bpel.factories.SupportingFactory#createFromPartsElement(java.util.List)} and
	 * {@link de.hpi.bpmn2bpel.factories.SupportingFactory#createToPartsElement(java.util.List)}.
	 * </p>
	 * 
	 * <p>
...
//		BPELUtil.setStandardAttributes(invoke, task);
	 ...
	 * created (see {@link #createReplyElement(de.hpi.bpel4chor.model.activities.SendTask)}).
	 * Otherwise an invoke element is created 
	 * (see {@link #createInvokeElement(de.hpi.bpel4chor.model.activities.SendTask)}).
	 * 
...
//		return createScopeForAttachedHandlers(reply, task);
	 ...
	 * {@link #createCopyElement(de.hpi.bpmn2bpel.model.supporting.Copy, de.hpi.bpel4chor.model.activities.AssignTask)}.
	 * </p>
	 * 
...
//		}
	 ...
	 * 
	 * @param task
	 * 		The {@link de.hpi.bpmn.Task} object.
	 * @return
	 * 		A list of the resulting {@link de.hpi.bpmn2bpel.model.supporting.Copy} objects.
	 */
...
//	}
	 ...
	 * connected {@link de.hpi.bpmn.Task}. The basic steps are:
	 * <ul>
	 * 	<li>
...
//	}
	...
	/**
	 * Creates a {@link de.hpi.bpmn2bpel.model.supporting.Copy} object based on the passed {@link de.hpi.bpmn.Task}.
	 * 
	 * @param dataObject
	 * 		The source {@link de.hpi.bpmn.Task}
	 * @return
...
//		}
	 ...
	 * {@link de.hpi.bpmn2bpel.factories.SupportingFactory#createExpressionElement(String, model.supporting.Expression)}.</p>
	 * 
