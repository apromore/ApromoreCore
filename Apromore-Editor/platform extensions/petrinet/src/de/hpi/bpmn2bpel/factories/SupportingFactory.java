...
public class SupportingFactory {
	 ...
	 * {@link #createVariableToSpec(de.hpi.bpmn2bpel.model.supporting.ToSpec)},
	 * {@link #createVariablePropertyToSpec(de.hpi.bpmn2bpel.model.supporting.ToSpec)} or
	 * {@link #createExpressionToSpec(de.hpi.bpmn2bpel.model.supporting.ToSpec)}.
	 * 
	 ...
	 * {@link #createVariableFromSpec(de.hpi.bpmn2bpel.model.supporting.FromSpec)},
	 * {@link #createVariablePropertyFromSpec(de.hpi.bpmn2bpel.model.supporting.FromSpec)} or
	 * {@link #createExpressionFromSpec(de.hpi.bpmn2bpel.model.supporting.FromSpec)}.
	 * 
...
//		}
	 ...
	 * 		At the moment it creates a variable for each {@link de.hpi.bpmn.Task}
	 * 		contained in the {@link de.hpi.bpmn2bpel.model.Container4BPEL}
	 * 
	 ...
	 * the given scope (see {@link #createCorrelationSetsElement(java.util.List)}.
	 * 
	...
	/**
	 * Creates a "correlationSets" element for the CorrelationSets defined in 
	 * the given process (see {@link #createCorrelationSetsElement(java.util.List)}.
	 * 
	 ...
	 * in the given scope (see {@link #createMessageExchangesElement(java.util.List)}).
	 * 
	...
	/**
	 * Creates a "messageExchanges" element for the message exchanges defined
	 * in the given process (see {@link #createMessageExchangesElement(java.util.List)}).
	 * 
