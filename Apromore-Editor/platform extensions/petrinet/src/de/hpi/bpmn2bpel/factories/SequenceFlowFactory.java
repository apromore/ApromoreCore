 ...
 * 
 * <p>
 * The factory uses the {@link de.hpi.bpmn2bpel.factories.Componentizer} to determine patterns in the
...
//	private StructuredElementsFactory structuredFactory = null;
	 ...
	 *            transformed.
	 * @param output
	 *            The {@link de.hpi.bpel4chor.util.Output} to print errors to.
	 */
...
//	}
	 ...
	 * <li>see {@link #isValidStartEvent(de.hpi.bpmn.StartEvent)}
	 * </ul>
	 * 
	 * @param startEvents
...
//	}
	 ...
	 * {@link StructuredElementsFactory#createLoopElement(de.hpi.bpmn.Activity, org.w3c.dom.Element)}),
...
//	}
	 ...
	 * {@link #isTrivial(de.hpi.bpmn.StartEvent, de.hpi.bpmn.EndEvent)}) to its BPEL4Chor elements it
...
//	}
	 ...
	 * {@link #foldComponent(de.hpi.bpmn2bpel.factories.Component, java.util.List)}).
	 * 
	 * @param comp
...
//		this.container.addTransition(fromTask);
	 ...
	 * {@link de.hpi.bpmn2bpel.factories.Componentizer#getNextComponent()}). If there are still activities
