...
public class ParticipantsFactory {
	 ...
	 * {@link #getType(de.hpi.bpel4chor.model.artifacts.ParticipantReferenceDataObject)} and if the data object
	 * is a participant set data object it is determined using 
	 * {@link #getType(de.hpi.bpel4chor.model.artifacts.ParticipantSetDataObject)}. Otherwise the result is null.
	 * 
	...
	*  The type is determined from the participant reference 
	 ...
	 * (see {@link #getForEach(de.hpi.bpel4chor.model.artifacts.ParticipantReferenceDataObject)}).
	 * 
	 ...
	 * (see {@link #getForEach(de.hpi.bpel4chor.model.artifacts.ParticipantSetDataObject)}).
	 * 
	 * The name of this multi-instance loop is combined with the prefix of the
	 * process the loop is contained in.
	 * 
	 ...
	 * (see {@link #getContainedReferences(de.hpi.bpel4chor.model.artifacts.ParticipantSetDataObject)}).
	 * 
	 ...
	 * (see {@link #getContainedSets(de.hpi.bpel4chor.model.artifacts.ParticipantSetDataObject)}).
	 * 
	 * @param document   The document to create the elements in.
	 * @param dataObject The participant set data object that containes the 
