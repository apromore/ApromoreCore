...
public final class ManagerPortalPortType_ManagerPortal_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        _writeUser_payloadUserSearchHistoriesVal1.setSearch("Search1579972430");
        _writeUser_payloadUserSearchHistoriesVal1.setNum(Integer.valueOf(1773007225));
        ...
        _writeUser_payloadUser.setFirstname("Firstname-1558432376");
        _writeUser_payloadUser.setLastname("Lastname-1994530447");
        _writeUser_payloadUser.setEmail("Email1739154692");
        _writeUser_payloadUser.setUsername("Username677513574");
        _writeUser_payloadUser.setPasswd("Passwd-2023809707");
        ...
        _editDataProcess_payload.setProcessName("ProcessName-870367762");
        _editDataProcess_payload.setId(Integer.valueOf(708944903));
        _editDataProcess_payload.setDomain("Domain-202126870");
        _editDataProcess_payload.setOwner("Owner1443786898");
        _editDataProcess_payload.setRanking("Ranking65660240");
        _editDataProcess_payload.setNewName("NewName-134142494");
        _editDataProcess_payload.setPreName("PreName171586574");
        ...
        _writeEditSession_payloadEditSession.setUsername("Username1008288162");
        _writeEditSession_payloadEditSession.setNativeType("NativeType336793134");
        _writeEditSession_payloadEditSession.setProcessId(Integer.valueOf(-1851530836));
        _writeEditSession_payloadEditSession.setProcessName("ProcessName1880231260");
        _writeEditSession_payloadEditSession.setVersionName("VersionName-1930413490");
        _writeEditSession_payloadEditSession.setDomain("Domain-1250776716");
        _writeEditSession_payloadEditSession.setWithAnnotation(Boolean.valueOf(false));
        _writeEditSession_payloadEditSession.setAnnotation("Annotation250993877");
        ...
        _exportFormat_payload.setNativeType("NativeType-1301313632");
        _exportFormat_payload.setProcessId(Integer.valueOf(-186930568));
        _exportFormat_payload.setProcessName("ProcessName62402783");
        _exportFormat_payload.setVersionName("VersionName-119258329");
        _exportFormat_payload.setAnnotationName("AnnotationName1897996305");
        ...
        _readNativeTypes_payload.setEmpty("Empty143949248");
        ...
        _readDomains_payload.setEmpty("Empty-1168694753");
        ...
        _readUser_payload.setUsername("Username-757413914");
        ...
        _readAllUsers_payload.setEmpty("Empty881031249");
        ...
        _deleteEditSession_payload.setEditSessionCode(Integer.valueOf(-1039050427));
        ...
        _deleteProcessVersions_payloadProcessVersionIdentifierVal1.setProcessid(Integer.valueOf(927024988));
        ...
        _importProcess_payload.setProcessName("ProcessName-1676838954");
        _importProcess_payload.setVersionName("VersionName1692365332");
        _importProcess_payload.setNativeType("NativeType275346217");
        _importProcess_payload.setDomain("Domain2100268613");
        _importProcess_payload.setUsername("Username1834093040");
        _importProcess_payload.setLastUpdate("LastUpdate2048896084");
        _importProcess_payload.setCreationDate("CreationDate-732412409");
        _importProcess_payload.setDocumentation("Documentation1157999932");
        ...
        _readProcessSummaries_payload.setSearchExpression("SearchExpression-451325765");
        ...
        _readEditSession_payload.setEditSessionCode(Integer.valueOf(539839330));
        ...
        _updateProcess_payload.setEditSessionCode(Integer.valueOf(-1631912675));
        _updateProcess_payload.setUsername("Username295576083");
        _updateProcess_payload.setNativeType("NativeType-349963106");
        _updateProcess_payload.setProcessId(Integer.valueOf(2141952173));
        _updateProcess_payload.setDomain("Domain-1456246190");
        _updateProcess_payload.setPreVersion("PreVersion555217342");
        _updateProcess_payload.setAnnotationName("AnnotationName449377154");
