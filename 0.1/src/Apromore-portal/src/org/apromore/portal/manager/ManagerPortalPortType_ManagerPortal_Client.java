...
public final class ManagerPortalPortType_ManagerPortal_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        _exportNative_payload.setNativeType("NativeType276535982");
        _exportNative_payload.setProcessId(Integer.valueOf(-1831419381));
        _exportNative_payload.setVersionName("VersionName598815794");
        ...
        _writeUser_payloadUserSearchHistoriesVal1.setSearch("Search2075889680");
        _writeUser_payloadUserSearchHistoriesVal1.setNum(Integer.valueOf(1045366916));
        ...
        _writeUser_payloadUser.setFirstname("Firstname-42322839");
        _writeUser_payloadUser.setLastname("Lastname1743779392");
        _writeUser_payloadUser.setEmail("Email-2042702188");
        _writeUser_payloadUser.setUsername("Username-1016203081");
        _writeUser_payloadUser.setPasswd("Passwd1241919727");
        ...
        _writeEditSession_payloadEditSession.setUsername("Username-1449185035");
        _writeEditSession_payloadEditSession.setNativeType("NativeType656262875");
        _writeEditSession_payloadEditSession.setProcessId(Integer.valueOf(2114608939));
        _writeEditSession_payloadEditSession.setProcessName("ProcessName-1423620902");
        _writeEditSession_payloadEditSession.setVersionName("VersionName507931881");
        _writeEditSession_payloadEditSession.setDomain("Domain-2011438876");
        ...
        _readFormats_payload.setEmpty("Empty1755085064");
        ...
        _readDomains_payload.setEmpty("Empty1119641451");
        ...
        _readUser_payload.setUsername("Username719443337");
        ...
        _deleteEditSession_payload.setEditSessionCode(Integer.valueOf(132725679));
        ...
        _deleteProcessVersions_payloadProcessVersionIdentifierVal1.setProcessid(Integer.valueOf(-6826771));
        ...
        _importProcess_payload.setProcessName("ProcessName1534621259");
        _importProcess_payload.setVersionName("VersionName1386779609");
        _importProcess_payload.setNativeType("NativeType353946403");
        _importProcess_payload.setDomain("Domain-448664320");
        _importProcess_payload.setUsername("Username1544296471");
        _importProcess_payload.setLastUpdate("LastUpdate-1550399320");
        _importProcess_payload.setCreationDate("CreationDate463118385");
        _importProcess_payload.setDocumentation("Documentation764399173");
        ...
        _readProcessSummaries_payload.setSearchExpression("SearchExpression1381311262");
        ...
        _readEditSession_payload.setEditSessionCode(Integer.valueOf(1281390084));
        ...
        _updateProcess_payload.setUsername("Username1775732536");
        _updateProcess_payload.setNativeType("NativeType2003198259");
        _updateProcess_payload.setProcessId(Integer.valueOf(-1251957655));
        _updateProcess_payload.setDomain("Domain-1037759504");
