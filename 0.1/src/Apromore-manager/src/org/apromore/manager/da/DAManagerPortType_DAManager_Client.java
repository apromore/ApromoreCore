...
public final class DAManagerPortType_DAManager_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        org.apromore.manager.model_manager.WriteUserInputMsgType _writeUser_payload = new org.apromore.manager.model_manager.WriteUserInputMsgType();
        org.apromore.manager.model_manager.UserType _writeUser_payloadUser = new org.apromore.manager.model_manager.UserType();
        java.util.List<org.apromore.manager.model_manager.SearchHistoriesType> _writeUser_payloadUserSearchHistories = new java.util.ArrayList<org.apromore.manager.model_manager.SearchHistoriesType>();
        org.apromore.manager.model_manager.SearchHistoriesType _writeUser_payloadUserSearchHistoriesVal1 = new org.apromore.manager.model_manager.SearchHistoriesType();
        ...
        org.apromore.manager.model_manager.WriteUserOutputMsgType _writeUser__return = port.writeUser(_writeUser_payload);
        ...
        org.apromore.manager.model_manager.ReadDomainsInputMsgType _readDomains_payload = new org.apromore.manager.model_manager.ReadDomainsInputMsgType();
        _readDomains_payload.setEmpty("Empty357407026");
        org.apromore.manager.model_manager.ReadDomainsOutputMsgType _readDomains__return = port.readDomains(_readDomains_payload);
        ...
        org.apromore.manager.model_manager.ReadFormatsInputMsgType _readFormats_payload = new org.apromore.manager.model_manager.ReadFormatsInputMsgType();
        _readFormats_payload.setEmpty("Empty896032750");
        org.apromore.manager.model_manager.ReadFormatsOutputMsgType _readFormats__return = port.readFormats(_readFormats_payload);
        ...
        org.apromore.manager.model_manager.ReadUserInputMsgType _readUser_payload = new org.apromore.manager.model_manager.ReadUserInputMsgType();
        _readUser_payload.setUsername("Username158534696");
        org.apromore.manager.model_manager.ReadUserOutputMsgType _readUser__return = port.readUser(_readUser_payload);
        ...
        org.apromore.manager.model_manager.ReadProcessSummariesInputMsgType _readProcessSummaries_payload = new org.apromore.manager.model_manager.ReadProcessSummariesInputMsgType();
        _readProcessSummaries_payload.setSearchExpression("SearchExpression-785670316");
        org.apromore.manager.model_manager.ReadProcessSummariesOutputMsgType _readProcessSummaries__return = port.readProcessSummaries(_readProcessSummaries_payload);
