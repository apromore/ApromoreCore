...
public interface DAManagerPortType {
    ...
    @WebResult(name = "UpdateProcessSummariesOutputMsg", targetNamespace = "http://www.apromore.org/data_access/model_manager", partName = "payload")
    @WebMethod(operationName = "UpdateProcessSummaries")
    public org.apromore.manager.model_da.UpdateProcessSummariesOutputMsgType updateProcessSummaries(
        @WebParam(partName = "payload", name = "UpdateProcessSummariesInputMsg", targetNamespace = "http://www.apromore.org/data_access/model_manager")
        org.apromore.manager.model_da.UpdateProcessSummariesInputMsgType payload
    );
