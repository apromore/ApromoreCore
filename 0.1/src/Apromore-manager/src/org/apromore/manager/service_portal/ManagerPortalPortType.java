...
public interface ManagerPortalPortType {
    ...
    public org.apromore.manager.model_portal.EditDataProcessOutputMsgType editDataProcess(
        @WebParam(partName = "payload", name = "EditDataProcessInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.apromore.manager.model_portal.EditDataProcessInputMsgType payload
    );
