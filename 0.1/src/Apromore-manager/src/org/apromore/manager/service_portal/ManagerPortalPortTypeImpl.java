...
@javax.jws.WebService(
    ...
    public org.apromore.manager.model_portal.SearchForSimilarProcessesOutputMsgType searchForSimilarProcesses(org.apromore.manager.model_portal.SearchForSimilarProcessesInputMsgType payload) { 
        ...
        try {
        	...
        	org.apromore.manager.model_toolbox.SearchForSimilarProcessesInputMsgType reqToToolbox = new org.apromore.manager.model_toolbox.SearchForSimilarProcessesInputMsgType();
        	reqToToolbox.setAlgorithm(payload.getAlgorithm());
        	org.apromore.manager.model_toolbox.ParametersType parametersToolbox = new org.apromore.manager.model_toolbox.ParametersType();
        	...
        	org.apromore.manager.model_toolbox.SearchForSimilarProcessesOutputMsgType respFromToolbox = toolbox.searchForSimilarProcesses(reqToToolbox);
            ...
            _returnResult.setCode(Integer.valueOf(-308276038));
            _return.setResult(_returnResult);
            java.util.List<org.apromore.manager.model_portal.CanonicalsType> _returnCanonicals = new java.util.ArrayList<org.apromore.manager.model_portal.CanonicalsType>();
            for (org.apromore.manager.model_toolbox.CanonicalsType c : respFromToolbox.getCanonicals()) {
            	
                org.apromore.manager.model_portal.CanonicalsType _returnCanonicalsVal1 = new org.apromore.manager.model_portal.CanonicalsType();
