...
import org.apromore.manager.model_manager.VersionSummaryType;
...
public class ManagerPortalPortTypeImpl implements ManagerPortalPortType {
	...
	public ImportProcessOutputMsgType importProcess(ImportProcessInputMsgType payload) { 
        ...
        try {
            ...
            org.apromore.manager.model_portal.ProcessSummaryType processSummaryP = 
            	new org.apromore.manager.model_portal.ProcessSummaryType();
            
            org.apromore.manager.model_canoniser.ProcessSummaryType processSummaryC = 
            	request.ImportProcess(payload.getUsername(), payload.getProcessName(), payload.getNativeType(), is);
            
            processSummaryP.setDomain(processSummaryC.getDomain());
			processSummaryP.setId(processSummaryC.getId());
			processSummaryP.setLastVersion(processSummaryC.getLastVersion());
			processSummaryP.setName(processSummaryC.getName());
			processSummaryP.setOriginalNativeType(processSummaryC.getOriginalNativeType());
			processSummaryP.setRanking(processSummaryC.getRanking());
			for (int i=0;i<processSummaryC.getVersionSummaries().size();i++) {
				org.apromore.manager.model_canoniser.VersionSummaryType versionC = processSummaryC.getVersionSummaries().get(i);
				org.apromore.manager.model_portal.VersionSummaryType versionP = 
					new org.apromore.manager.model_portal.VersionSummaryType();
				processSummaryC.getVersionSummaries().add(versionC);
				versionC.setCreationDate(versionP.getCreationDate());
				versionC.setLastUpdate(versionP.getLastUpdate());
				versionC.setName(versionP.getName());
				versionC.setRanking(versionP.getRanking());
			}
        	res.setProcessSummary(processSummaryP);
            result.setCode(0);
            result.setMessage("");
