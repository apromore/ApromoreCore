...
@javax.jws.WebService(
	...
	public UpdateProcessOutputMsgType updateProcess(UpdateProcessInputMsgType payload) { 
		...
		try {
			...
			request.CanoniseVersion (processId, preVersion, newVersion,
					nativeType, domain, username, native_is, documentation, created, lastupdate);
			result.setCode(0);
			result.setMessage("");
		} catch (Exception ex) {
			ex.printStackTrace();
