...
public class DAManagerService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.apromore.org/dataaccess/service_manager", "DAManagerService");
    public final static QName DAManager = new QName("http://www.apromore.org/dataaccess/service_manager", "DAManager");
    static {
        URL url = null;
        try {
