...
@javax.jws.WebService(
	...
	public StoreVersionOutputMsgType storeVersion(StoreVersionInputMsgType payload) { 
		...
		Date created = payload.getCreationDate();
		Date lastupdate = payload.getLastUpdate();
        ...
        try {
			...
			ProcessDao.getInstance().storeVersion (processId, preVersion, newVersion, username, nativeType,
					domain, documentation, created, lastupdate, native_is, cpf_is, anf_is);
        	result.setCode(0);
			result.setMessage("");
        } catch (Exception ex) {
			ex.printStackTrace();
