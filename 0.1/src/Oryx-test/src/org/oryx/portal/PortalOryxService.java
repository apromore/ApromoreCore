...
public class PortalOryxService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/Apromore-portal/services?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://localhost:8080/Apromore-portal/services?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
