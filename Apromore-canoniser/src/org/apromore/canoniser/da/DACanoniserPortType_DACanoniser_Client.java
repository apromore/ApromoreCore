...
public final class DACanoniserPortType_DACanoniser_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        _storeNativeCpf_payload.setProcessName("ProcessName-1678719318");
        _storeNativeCpf_payload.setNativeType("NativeType-169238801");
        _storeNativeCpf_payload.setUsername("Username-1437743845");
        ...
        _storeNativeCpf_payloadCpfNetVal1.setId(new java.math.BigInteger("-90489453267458232293803799142547550307"));
        ...
        _storeNativeCpf_payloadCpfResourceTypeVal1.setName("Name2100239025");
        _storeNativeCpf_payloadCpfResourceTypeVal1.setConfigurable(Boolean.valueOf(false));
        _storeNativeCpf_payloadCpfResourceTypeVal1.setId(new java.math.BigInteger("-9779499246934096375679370910080287638"));
        ...
        _storeNativeCpf_payloadCpfObjectVal1.setName("Name-282367802");
        _storeNativeCpf_payloadCpfObjectVal1.setConfigurable(Boolean.valueOf(false));
        _storeNativeCpf_payloadCpfObjectVal1.setId(new java.math.BigInteger("-23260406547275803072398649415046950436"));
        ...
        _storeNativeCpf_payloadCpf.setUri("Uri2035296519");
        _storeNativeCpf_payloadCpf.setVersion(new java.math.BigDecimal("-8061631170138658638.5411743206755934812"));
        _storeNativeCpf_payloadCpf.setName("Name-250748367");
        _storeNativeCpf_payloadCpf.setRootId(new java.math.BigInteger("3670078551459325289267716833869093789"));
        ...
        _storeNativeCpf_payloadAnfAnnotationVal1.setId(new java.math.BigInteger("5206472829969254490612936485664588215"));
        _storeNativeCpf_payloadAnfAnnotationVal1.setCpfId(new java.math.BigInteger("40345697407663934743738437330485927109"));
        ...
        _storeNativeCpf_payloadAnf.setUri("Uri1946497180");
        _storeNativeCpf_payloadAnf.setVersion(new java.math.BigDecimal("-6757214969829507933.4428347236637137204"));
        _storeNativeCpf_payloadAnf.setName("Name-1520170900");
        _storeNativeCpf_payloadAnf.setCpfUri("CpfUri1516922732");
        _storeNativeCpf_payloadAnf.setCpfVersion(new java.math.BigDecimal("9007654849500937963.5188716169492217813"));
