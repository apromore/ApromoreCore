...
public class ModelToLogComparisonController extends BaseController {
        ...
        if (hbox != null) {
            ...
            try {
                ...
                for (int i=0; i < array.length(); i++) {
                    ...
                    final Button button = new Button(difference.getString("sentence") + " (" + rankingFormat.format(difference.getDouble("ranking")) + " of traces)");
    ...
    private String differenceToJavascript(int buttonIndex, JSONObject difference) throws JSONException {
            ...
            return "editor.displayMLDifference(" +
                    buttonIndex + "," +
