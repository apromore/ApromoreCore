...
@XmlSeeAlso({org.test_oryx.model_portal.ObjectFactory.class})
...
public interface PortalOryxPortType {
    ...
    public org.test_oryx.model_portal.WriteProcessOutputMsgType writeProcess(
        @WebParam(partName = "payload", name = "WriteProcessInputMsg", targetNamespace = "http://www.apromore.org/portal/model_oryx")
        org.test_oryx.model_portal.WriteProcessInputMsgType payload
    );
    ...
    public org.test_oryx.model_portal.WriteNewAnnotationOutputMsgType writeNewAnnotation(
        @WebParam(partName = "payload", name = "WriteNewAnnotationInputMsg", targetNamespace = "http://www.apromore.org/portal/model_oryx")
        org.test_oryx.model_portal.WriteNewAnnotationInputMsgType payload
    );
    ...
    public org.test_oryx.model_portal.WriteNewProcessOutputMsgType writeNewProcess(
        @WebParam(partName = "payload", name = "WriteNewProcessInputMsg", targetNamespace = "http://www.apromore.org/portal/model_oryx")
        org.test_oryx.model_portal.WriteNewProcessInputMsgType payload
    );
    ...
    public org.test_oryx.model_portal.ReadNativeOutputMsgType readNative(
        @WebParam(partName = "payload", name = "ReadNativeInputMsg", targetNamespace = "http://www.apromore.org/portal/model_oryx")
        org.test_oryx.model_portal.ReadNativeInputMsgType payload
    );
    ...
    public org.test_oryx.model_portal.CloseSessionOutputMsgType closeSession(
        @WebParam(partName = "payload", name = "CloseSessionInputMsg", targetNamespace = "http://www.apromore.org/portal/model_oryx")
        org.test_oryx.model_portal.CloseSessionInputMsgType payload
    );
    ...
    public org.test_oryx.model_portal.WriteAnnotationOutputMsgType writeAnnotation(
        @WebParam(partName = "payload", name = "WriteAnnotationInputMsg", targetNamespace = "http://www.apromore.org/portal/model_oryx")
        org.test_oryx.model_portal.WriteAnnotationInputMsgType payload
    );
}
