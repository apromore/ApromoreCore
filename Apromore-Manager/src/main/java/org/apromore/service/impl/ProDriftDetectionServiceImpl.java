...
import org.apromore.service.ProDriftDetectionService;
...
public class ProDriftDetectionServiceImpl implements ProDriftDetectionService {
    ...
    public ProDriftDetectionResult proDriftDetector(byte[] logByteArray, int winSize, String fWinorAwin, String logFileName) throws ExceptionProDriftDetection {
