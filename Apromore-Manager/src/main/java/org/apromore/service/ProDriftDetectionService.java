...
public interface ProDriftDetectionService {
     ...
     * @throws ExceptionProDriftDetection if the merge failed
     */
    ProDriftDetectionResult proDriftDetector(byte[] logByteArray, int winSize, String fWinorAwin, String logFileName) throws ExceptionProDriftDetection;
