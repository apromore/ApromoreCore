...
DROP TABLE IF EXISTS `native_format`;
...
CREATE TABLE `native_type` (
    ...
    `nativeType` varchar(20) NOT NULL DEFAULT '',
...
CREATE TABLE `process` (
    ...
    `nativeType` int(11) DEFAULT NULL,
    `folderId` int(11) DEFAULT NULL,
    PRIMARY KEY (`id`),
    KEY `fk_process2` (`nativeType`),
    KEY `fk_users` (`owner`),
    KEY `fk_folder` (`folderId`),
    CONSTRAINT `fk_folder` FOREIGN KEY (`folderId`)
        REFERENCES `folder` (`id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_processOwner` FOREIGN KEY (`owner`)
        REFERENCES `user` (`id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_processNativeType` FOREIGN KEY (`nativeType`)
        REFERENCES `native_type` (`id`)
        ON DELETE CASCADE ON UPDATE CASCADE
)  ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `native_format` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
    `content` longtext,
    `nativeType` int(11) DEFAULT NULL,
    `processModelVersionId` int(11) NULL,
    PRIMARY KEY (`id`),
    CONSTRAINT `fk_native` FOREIGN KEY (`nativeType`)
        REFERENCES `native_type` (`id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `edit_session` (
    ...
    `nativeType` varchar(20) DEFAULT NULL,
...
CREATE TABLE `process_model_version` (
    ...
    `nativeFormatId` int(11) DEFAULT NULL,
    ...
    CONSTRAINT `fk_process_branch_model_version` FOREIGN KEY (`branchId`)
        ...
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_process_model_native` FOREIGN KEY (`nativeFormatId`)
        REFERENCES `native_format` (`id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_process_model_annotation` FOREIGN KEY (`annotationId`)
        REFERENCES `annotation` (`id`)
        ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_root_process_model_version` FOREIGN KEY (`rootFragmentVersionId`)
...
CREATE INDEX `idx_native_type` ON `nativeType` (`nativeType`, `extension`) USING BTREE;
...
LOCK TABLES `nativeType` WRITE;
/*!40000 ALTER TABLE `nativeType` DISABLE KEYS */;
INSERT INTO `nativeType` VALUES (1,'EPML 2.0','epml');
INSERT INTO `nativeType` VALUES (2,'XPDL 2.1','xpdl');
INSERT INTO `nativeType` VALUES (3,'PNML 1.3.2', 'pnml');
INSERT INTO `nativeType` VALUES (4,'YAWL 2.2', 'yawl');
INSERT INTO `nativeType` VALUES (5,'BPMN 2.0', 'bpmn');
INSERT INTO `nativeType` VALUES (6,'AML fragment', 'aml');
/*!40000 ALTER TABLE `nativeType` ENABLE KEYS */;
UNLOCK TABLES;
