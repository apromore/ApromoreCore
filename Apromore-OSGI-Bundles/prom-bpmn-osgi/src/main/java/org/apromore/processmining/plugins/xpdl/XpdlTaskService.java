 ...
 * @author hverbeek
 * 
 *         <xsd:element name="TaskService"> <xsd:annotation>
 *         <xsd:documentation>BPMN</xsd:documentation> </xsd:annotation>
 *         <xsd:complexType> <xsd:sequence> <xsd:element name="MessageIn"
 ...
 *         </xsd:element> <xsd:element ref="xpdl:WebServiceOperation"
 *         minOccurs="0"/> <xsd:element ref="xpdl:WebServiceFaultCatch"
 ...
 *         default="WebService"> <xsd:annotation> <xsd:documentation> BPMN:
 *         Implementation-related, but required if the Task is Service
 ...
 *         </xsd:element>
 */
public class XpdlTaskService extends XpdlElement {
	...
	public XpdlTaskService(String tag) {
		super(tag);
