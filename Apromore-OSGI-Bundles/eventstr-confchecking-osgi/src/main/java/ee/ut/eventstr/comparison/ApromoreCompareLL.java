...
//        String log2Name = "/Users/abelarmas/Dropbox/BPM2015-VarianceAnalysis/tool/ProDelta/Logs/par_seq.mxml";
        String log1Name = "/Volumes/MobileData/Logs/Deviance Mining/Reduced Logs/Deviance Mining - Correct.xes.gz";
        String log2Name = "/Volumes/MobileData/Logs/Deviance Mining/Reduced Logs/dev.8.xes.gz";
...
//        String log2Name = "/Volumes/RaffaeleCode/test2.xes";
		...
		try {
			...
			for(Quadruplet<String, Set<XTrace>, Set<XTrace>, Integer> quadruplet : compareLL.getDifferencesQuadrupletsAStar(log1, "normal behaviour", log2, "deviant behaviour")){
					System.out.println(quadruplet.getA());
                	System.out.println(quadruplet.getB().size());
                	System.out.println(quadruplet.getC().size());
                    System.out.println(quadruplet.getD());
            }
    ...
    public Set<Quadruplet<String, Set<XTrace>, Set<XTrace>, Integer>> getDifferencesQuadrupletsAStar(XLog log1, String logName1, XLog log2, String logName2) {
        PrimeEventStructure<Integer> logpes1 = getLogPES(log1, "log 1");
        PrimeEventStructure<Integer> logpes2 = getLogPES(log2, "log 2");
        ...
        DiffLLVerbalizerQuadruplet<Integer> verbalizer = new DiffLLVerbalizerQuadruplet<>(fullLogPesSem1, logName1, fullLogPesSem2, logName2);
        ...
        for (int sink1: sinks1) {
            ...
            verbalizer.addPSP(psp.getOperationSequence(), psp.cost);
...
//	public Set<Quadruplet<String, Set<XTrace>, Set<XTrace>>> getDifferencesTriplets(XLog log1, String logName1, XLog log2, String logName2) {
//        PrimeEventStructure<Integer> logpes1 = getLogPES(log1, "log 1");
//        PrimeEventStructure<Integer> logpes2 = getLogPES(log2, "log 2");
//
//        PESSemantics<Integer> fullLogPesSem1 = new PESSemantics<>(logpes1);
