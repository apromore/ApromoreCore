...
public class AddedTaskTest {
	...
	public PrimeEventStructure<Integer> getPES1() {
		...
		return PORuns2PES.getPrimeEventStructure(
				adj, conc, Arrays.asList(0), Arrays.asList(2), Arrays.asList("a", "b", "c"), "PES1");
	}
	public PrimeEventStructure<Integer> getPES2() {
		...
		return PORuns2PES.getPrimeEventStructure(
				adj, conc, Arrays.asList(0), Arrays.asList(1), Arrays.asList("a", "c"), "PES2");
	}
}
