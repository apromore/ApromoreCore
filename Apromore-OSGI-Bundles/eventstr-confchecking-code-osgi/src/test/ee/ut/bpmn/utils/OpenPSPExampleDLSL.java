...
//--
//OpenPSP test Double loop - Single loop: BPMN with double, nested loop vs log with single loop
//--
...
public class OpenPSPExampleDLSL {
	...
	public UnfoldingPESSemantics<Integer> getUnfoldingPESExample() throws JDOMException, IOException {
		BPMNProcess<Element> model = BPMN2Reader.parse(new File("E:/JavaProjects/workspace/eventstr-confcheck/eventstr-confchecking/models/nestedloop.bpmn"));
	...
	public PESSemantics<Integer> getLogPESExample() throws Exception {
		...
		PrimeEventStructure<Integer> pes = PORuns2PES.getPrimeEventStructure(
				adj, conc, Arrays.asList(0), Arrays.asList(8, 14), Arrays.asList("_0_", "start", "init", "A", "B", "C", "D", "end", "_1_", "A", "B", "C", "D", "end", "_1_"), "PES1");
