...
public class OpenPSPExample1qTest {
	...
	public PESSemantics<Integer> getLogPESExample() throws Exception {
		...
		conc.put(14, 15); conc.put(15, 14);
		PrimeEventStructure<Integer> pes = PORuns2PES.getPrimeEventStructure(
				adj, conc, Arrays.asList(0), Arrays.asList(11, 13, 18), Arrays.asList("_0_", "start", "init", "A", "C", "B", "D", "B", "C", "end", "D", "_1_", "end", "_1_", "B", "C", "D", "end", "_1_"), "PES1");
