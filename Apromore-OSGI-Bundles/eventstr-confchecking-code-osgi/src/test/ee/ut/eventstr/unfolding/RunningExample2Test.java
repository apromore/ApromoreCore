...
public class RunningExample2Test {
	@Test
	...
	public NewUnfoldingPESSemantics<Integer> getUnfoldingPESExample() throws JDOMException, IOException {
		...
		net.addArc(tau2, p4); net.addArc(p4, c);
		net.addArc(tau3, p5);
		net.addArc(c, p5); net.addArc(p5, tau4);
		net.addArc(tau4, p6); net.addArc(b, p7);
		net.addArc(p6, tau5); net.addArc(p7, tau5);
		net.addArc(tau5, p8);
		net.addArc(p8, d);
		
		net.addArc(d, p9);
		net.addArc(p9, tau6); net.addArc(p9, tau7);
		net.addArc(tau6, p10); net.addArc(tau7, p11);
		net.addArc(p10, e); net.addArc(p11, f);
		net.addArc(e, p12); net.addArc(f, p12);
		net.addArc(p12, tau8); net.addArc(tau8, p13);
