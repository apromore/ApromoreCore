...
public class ScalabilityLoopTest {
	String logfilename;
	String bpmnfilename;
	...
	public void test() throws Exception {
		logfilename ="loopTestLog";
		bpmnfilename = "loopTest";
		logfiletemplate	= "E:/JavaProjects/workspace/FancyJavaUtilities/logs/loops/%s.mxml";
		bpmnfolder = "E:/JavaProjects/workspace/FancyJavaUtilities/bpmn/loops/";
