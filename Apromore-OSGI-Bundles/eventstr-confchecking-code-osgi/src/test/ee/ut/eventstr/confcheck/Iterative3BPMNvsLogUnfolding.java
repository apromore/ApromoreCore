...
public class Iterative3BPMNvsLogUnfolding {
	
	final boolean VERBALIZING = false;
...
//				"models/simple/"
		...
		DiffVerbalizer<Integer> verbalizer = new DiffVerbalizer<Integer>(fullLogPesSem, bpmnpes);
