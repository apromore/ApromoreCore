...
import ee.ut.eventstr.comparison.NPrunedOpenPartialSynchronizedProduct;
import ee.ut.eventstr.comparison.PrunedOpenPartialSynchronizedProduct;
import ee.ut.eventstr.comparison.RBFSOpenPartialSynchronizedProduct;
...
public class CopyOfIterative3BPMNvsLogUnfolding {
...
//				"models/simple/"
		...
		NPrunedOpenPartialSynchronizedProduct<Integer> psp;
...
//		sink = 900;
			...
			psp = new NPrunedOpenPartialSynchronizedProduct<Integer>(logpessem, bpmnpes);
