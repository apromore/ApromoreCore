...
import ee.ut.eventstr.comparison.NewOpenPartialSynchronizedProduct.Operation.Op;
import ee.ut.org.processmining.framework.util.Pair;

public class NewOpenPartialSynchronizedProduct<T> {
	...
	public NewOpenPartialSynchronizedProduct(PESSemantics<T> pes1, NewUnfoldingPESSemantics<T> pes2) {
		this.pes1 = pes1;
		this.pes2 = pes2;
	...
	public NewOpenPartialSynchronizedProduct<T> perform() {
...
//							}
	...
	public NewOpenPartialSynchronizedProduct<T> prune() {
