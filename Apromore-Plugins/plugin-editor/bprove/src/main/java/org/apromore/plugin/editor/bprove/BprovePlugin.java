 ...
 */
@Component("plugin")
public class BprovePlugin extends DefaultEditorPlugin {

    @Override
    public String getJavaScriptURI() {
        return "/bprove/bprove.js"; //TODO automatically get root dir via BundleContext
    }

    @Override
    public String getJavaScriptPackage() {
        return "ORYX.Plugins.Bprove";
    }
