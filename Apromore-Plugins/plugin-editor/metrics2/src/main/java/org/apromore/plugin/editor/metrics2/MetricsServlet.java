...
package org.apromore.plugin.editor.metrics2;
...
public class MetricsServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        String bpmnXML = request.getParameter("data");
        ...
        try {
            if (bpmnXML == null || bpmnXML.isEmpty()) {
                ...
                String metrics = compute(bpmnXML);
    ...
    private String compute(String bpmnXML) throws Exception {
        BPMNDiagram bpmnDiagram = importerService.importBPMNDiagram(bpmnXML);
