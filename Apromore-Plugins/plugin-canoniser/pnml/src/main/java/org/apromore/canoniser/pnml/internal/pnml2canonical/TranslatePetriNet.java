    ...
    public void translatePetriNet(org.apromore.pnml.NetType pnet) throws CanoniserException {
        for (Object obj : pnet.getArc()) {
            if (obj instanceof ArcType) {
                data.addtargetvalues(String.valueOf(((org.apromore.pnml.NodeType) ((ArcType) obj).getSource()).getId()));
                data.addsourcevalues(String.valueOf(((org.apromore.pnml.NodeType) ((ArcType) obj).getTarget()).getId()));
                data.addinput(String.valueOf(((org.apromore.pnml.NodeType) ((ArcType) obj).getSource()).getId()));
                data.addoutput(String.valueOf(((org.apromore.pnml.NodeType) ((ArcType) obj).getTarget()).getId()));
            }
        }
        ...
        for (Object obj : pnet.getPlace()) {
            if (obj instanceof PlaceType) {
                if (data.gettargetvalues().contains(((PlaceType) obj).getId()) || data.getsourcevalues().contains(((PlaceType) obj).getId())) {
                    if (!data.getinput().contains(((PlaceType) obj).getId()) && data.getoutput().contains(((PlaceType) obj).getId())) {
                        data.setOutputnode(String.valueOf(((org.apromore.pnml.NodeType) obj).getId()));
                        tts.setValues(data, ids);
                        tts.translateOutput((PlaceType) obj);
                        addNodeAnnotations(obj);

                    } else if (data.getinput().contains(((PlaceType) obj).getId()) && !data.getoutput().contains(((PlaceType) obj).getId())) {
                        data.setInputnode(String.valueOf(((org.apromore.pnml.NodeType) obj).getId()));
                        tts.setValues(data, ids);
        ...
        for (Object obj : pnet.getTransition()) {
            if (obj instanceof TransitionType) {
                if (((TransitionType) obj).getToolspecific().size() >= 1|| (data.gettargetvalues().contains(((TransitionType) obj).getId())
                        || data.getsourcevalues().contains(((TransitionType) obj).getId()))) {

                    if (((TransitionType) obj).getToolspecific().size() >= 1) {
                        for (Object obj2 : ((TransitionType) obj).getToolspecific()) {

                            if ((data.gettargetvalues().contains(((TransitionType) obj).getId())
                                    || data.getsourcevalues().contains(((TransitionType) obj).getId()))
                                    && ((TransitionToolspecificType) obj2).getOperator() == null) {
                                ...
                                if (((TransitionToolspecificType) obj2).getOperator() != null) {
                                    to.setValues(data, ids);
                                    to.translateOperation((TransitionToolspecificType) obj2, (TransitionType) obj);
                                    ids = to.getIds();
                                    addNodeAnnotations(obj);
