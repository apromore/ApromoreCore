...
public class BpmndiDiagram extends BPMNDiagram {
    ...
    public BpmndiDiagram(final AnnotationsType anf, final Initializer initializer, final boolean fromEPML) {
                ...
                @Override public void visit(final GraphicsType graphics) {
                    try {
                        ...
                        if (bpmnElement instanceof TDataObject          ||
                            ...
                            if (bpmnElement instanceof TEvent || bpmnElement instanceof TActivity || bpmnElement instanceof TGateway) {
                                bpmnPlane.getDiagramElement().add(bpmndiObjectFactory.createBPMNShape(new BpmndiShape(graphics, initializer, fromEPML)));
                            } else {
