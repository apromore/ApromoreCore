...
public class ConversionUtilsUnitTest {
    ...
    public void testIsValidFragment() throws CanoniserException {
        final Element fragment = ConversionUtils.marshalYAWLFragment("yawlService", new WebServiceGatewayFactsType.YawlService(),
                WebServiceGatewayFactsType.YawlService.class);
        assertTrue(ConversionUtils.isValidFragment(fragment, "http://www.yawlfoundation.org/yawlschema", "yawlService"));
        assertFalse(ConversionUtils.isValidFragment(fragment, "", "yawlService"));
    }
    ...
    public void testUnmarshalYAWLFragment() throws CanoniserException {
        ...
        final Element fragment = ConversionUtils.marshalYAWLFragment("yawlService", serviceOld, WebServiceGatewayFactsType.YawlService.class);
        final YawlService serviceNew = ConversionUtils.unmarshalYAWLFragment(fragment, WebServiceGatewayFactsType.YawlService.class);
    ...
    public void testMarshalYAWLFragment() throws CanoniserException {
        ...
        final Element fragment2 = ConversionUtils.marshalYAWLFragment("configuration", new ConfigurationType(), ConfigurationType.class);
    ...
    public void testAddToExtensionsElementNodeType() throws CanoniserException {
        ...
        ConversionUtils.addToExtensions(fragment, node);
    ...
    public void testAddToExtensionsElementCanonicalProcessType() throws CanoniserException {
        ...
        ConversionUtils.addToExtensions(fragment, cpf);
    ...
    public void testAddToExtensionsElementNetType() throws CanoniserException {
        ...
        ConversionUtils.addToExtensions(fragment, net);
    ...
    public void testAddToExtensionsElementResourceTypeType() throws CanoniserException {
        ...
        ConversionUtils.addToExtensions(fragment, resource);
