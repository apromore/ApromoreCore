...
public class StructuredSynchronisingMergeUnitTest extends BasePatternUnitTest {
    ...
    protected File getYAWLFile() {
        return new File(TestUtils.TEST_RESOURCES_DIRECTORY + "YAWL/Patterns/ControlFlow/WPC7StructuredSynchronisingMerge.yawl");
    }

    @Test
    public void testStructuredSynchronisingMerge() {
