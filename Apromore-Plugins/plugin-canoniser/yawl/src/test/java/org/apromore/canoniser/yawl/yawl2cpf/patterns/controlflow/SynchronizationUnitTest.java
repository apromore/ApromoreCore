...
public class SynchronizationUnitTest extends BasePatternUnitTest {
    ...
    protected File getYAWLFile() {
        return new File(TestUtils.TEST_RESOURCES_DIRECTORY + "YAWL/Patterns/ControlFlow/WPC3Synchronization.yawl");
    }

    @Test
    public void testIsSynchronisation() {
