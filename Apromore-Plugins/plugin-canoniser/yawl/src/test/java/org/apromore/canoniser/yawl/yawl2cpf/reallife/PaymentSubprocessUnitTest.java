...
public class PaymentSubprocessUnitTest extends BaseYAWL2CPFUnitTest {
    ...
    protected File getYAWLFile() {
        return new File(TestUtils.TEST_RESOURCES_DIRECTORY + "YAWL/Orderfulfillment/PaymentSubnet.yawl");
    }
