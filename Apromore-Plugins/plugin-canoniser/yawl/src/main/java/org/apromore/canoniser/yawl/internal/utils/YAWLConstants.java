...
public final class YAWLConstants {
    ...
    public static final String YAWL_ALLOCATOR_ROUND_ROBIN_BY_LEAST_FREQUENCY = "RoundRobinByLeastFrequency";

    public static final String YAWL_ALLOCATOR_ROUND_ROBIN_BY_EXPERIENCE = "RoundRobinByExperience";
