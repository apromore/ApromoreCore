...
public class Canonical2YAWLImpl implements Canonical2YAWL {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(Canonical2YAWLImpl.class.getName());
    ...
    public void convertToYAWL(final CanonicalProcessType canonicalType, final AnnotationsType annotationsType) throws CanoniserException {
        ...
        // Handlers
        this.context = new CanonicalConversionContext(canonicalType, annotationsType);
