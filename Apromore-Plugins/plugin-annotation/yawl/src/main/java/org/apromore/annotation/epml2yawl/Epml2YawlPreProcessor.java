...
package org.apromore.annotation.epml2yawl;
...
/**
 * EPML to YAWL Pre Processor.
 * Used to manipulate the EPML of the YAWL output when the input process langauge was EPML.
 * Used to change the size of the shapes as each language has different sizes elements.
 *
 * @author <a href="mailto:cam.james@gmail.com">Cameron James</a>
 */
@Component("epml2yawlPreAnnotationProcessor")
public class Epml2YawlPreProcessor extends DefaultAbstractAnnotationProcessor {
