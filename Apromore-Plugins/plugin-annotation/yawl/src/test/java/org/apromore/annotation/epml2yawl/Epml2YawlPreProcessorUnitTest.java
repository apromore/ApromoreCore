 ...
 */
public class Epml2YawlPreProcessorUnitTest {

    Epml2YawlPreProcessor epml2YawlPostProcessor;

    @Test
    public void testProcessAnnotation() throws Exception {
        epml2YawlPostProcessor = new Epml2YawlPreProcessor();

        CanonicalProcessType cpf = buildCPF();
        AnnotationsType anf = buildANF();

        epml2YawlPostProcessor.processAnnotation(cpf, anf);
