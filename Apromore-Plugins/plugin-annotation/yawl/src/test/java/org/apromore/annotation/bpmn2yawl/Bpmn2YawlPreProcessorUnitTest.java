 ...
 */
public class Bpmn2YawlPreProcessorUnitTest {

    Bpmn2YawlPreProcessor bpmn2YawlPostProcessor;

    @Test
    public void testProcessAnnotation() throws Exception {
        bpmn2YawlPostProcessor = new Bpmn2YawlPreProcessor();

        CanonicalProcessType cpf = buildCPF();
        AnnotationsType anf = buildANF();

        bpmn2YawlPostProcessor.processAnnotation(cpf, anf);
