...
package org.apromore.annotation.xpdl2bpmn;
...
/**
 * XPDL to BPMN Pre Processor.
 * Used to manipulate the XPDL of the BPMN output when the input process langauge was XPDL.
 * Used to change the size of the shapes as each language has different sizes elements.
 *
 * @author <a href="mailto:cam.james@gmail.com">Cameron James</a>
 */
@Component("xpdl2bpmnPreAnnotationProcessor")
public class Xpdl2BpmnPreProcessor extends DefaultAbstractAnnotationProcessor {
