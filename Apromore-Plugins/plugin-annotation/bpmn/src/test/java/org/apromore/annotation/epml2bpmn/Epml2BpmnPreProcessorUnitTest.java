...
public class Epml2BpmnPreProcessorUnitTest {
    ...
    public void testProcessAnnotation() throws Exception {
        ...
        assertThat(((GraphicsType) anf.getAnnotation().get(2)).getPosition().get(0).getX().doubleValue(),  equalTo(57.75));
        assertThat(((GraphicsType) anf.getAnnotation().get(2)).getPosition().get(0).getY().doubleValue(),  equalTo(57.75));
        assertThat(((GraphicsType) anf.getAnnotation().get(2)).getPosition().get(1).getX().doubleValue(),  equalTo(115.25));
        assertThat(((GraphicsType) anf.getAnnotation().get(2)).getPosition().get(1).getY().doubleValue(),  equalTo(120.25));
    }
