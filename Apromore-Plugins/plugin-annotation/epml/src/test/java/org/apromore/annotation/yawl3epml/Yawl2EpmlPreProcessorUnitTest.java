...
package org.apromore.annotation.yawl3epml;

import org.apromore.anf.AnnotationsType;
import org.apromore.anf.GraphicsType;
import org.apromore.anf.PositionType;
import org.apromore.anf.SizeType;
import org.apromore.annotation.yawl2epml.Yawl2EpmlPreProcessor;
...
/**
 * Test that the Yawl2Epml Pre Processor does what it's suppose to.
 *
 * @author <a href="mailto:cam.james@gmail.com">Cameron James</a>
 */
public class Yawl2EpmlPreProcessorUnitTest {

    Yawl2EpmlPreProcessor yawl2EpmlPostProcessor;

    @Test
    public void testProcessAnnotation() throws Exception {
        yawl2EpmlPostProcessor = new Yawl2EpmlPreProcessor();

        CanonicalProcessType cpf = buildCPF();
        AnnotationsType anf = buildANF();

        yawl2EpmlPostProcessor.processAnnotation(cpf, anf);
