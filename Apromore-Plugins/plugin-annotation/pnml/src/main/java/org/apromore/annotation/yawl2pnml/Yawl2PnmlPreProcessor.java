...
package org.apromore.annotation.yawl2pnml;
...
/**
 * YAWL to PNML Post Processor.
 * Used to manipulate the ANF of the YAWL output when the input process langauge was PNML.
 * Used to change the size of the shapes as each language has different sizes elements.
 *
 * @author <a href="mailto:cam.james@gmail.com">Cameron James</a>
 */
@Component("yawl2pnmlPreAnnotationProcessor")
public class Yawl2PnmlPreProcessor extends DefaultAbstractAnnotationProcessor {

    private static final BigDecimal divisor = new BigDecimal(2.0);
    private static final BigDecimal newEventHeight = new BigDecimal(40.);
    private static final BigDecimal newEventWidth = new BigDecimal(40.0);
    private static final BigDecimal newTaskHeight = new BigDecimal(40.0);
    private static final BigDecimal newTaskWidth = new BigDecimal(40.0);
