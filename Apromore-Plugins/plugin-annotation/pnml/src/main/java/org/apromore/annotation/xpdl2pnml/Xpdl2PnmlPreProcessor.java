...
package org.apromore.annotation.xpdl2pnml;
...
/**
 * XPDL to PNML Post Processor.
 * Used to manipulate the ANF of the XPDL output when the input process langauge was PNML.
 * Used to change the size of the shapes as each language has different sizes elements.
 *
 * @author <a href="mailto:cam.james@gmail.com">Cameron James</a>
 */
@Component("xpdl2pnmlPreAnnotationProcessor")
public class Xpdl2PnmlPreProcessor extends DefaultAbstractAnnotationProcessor {
