...
public class ProcessServiceImplUnitTest {
    ...
    public final void setUp() throws Exception {
        ...
        service = new ProcessServiceImpl(annDao, contDao, natDao, branchDao, proDao, fvDao, fvdDao, pmvDao,
                convertor, canSrv, fSrv, lSrv, usrSrv, fmtSrv, composerSrv, decomposerSrv, ui);
    }
    ...
    public void testExportFormatGetCanonical() throws Exception {
        ...
        expect(pmvDao.getCurrentProcessModelVersion(name, version)).andReturn(pmv);
