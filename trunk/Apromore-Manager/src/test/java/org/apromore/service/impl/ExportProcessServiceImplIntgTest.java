...
public class ExportProcessServiceImplIntgTest {
    ...
    public void testExportProcessWithSingleEdgeInEPML() throws Exception {
        ...
        ProcessModelVersion pst = pSrv.importProcess(username, name, epmlNativeType, startCP, startStream.getInputStream(), domain, "", created, lastUpdate);
    ...
    public void testExportProcessWithObjectsResourcesInXPDL() throws Exception {
        ...
        ProcessModelVersion pst = pSrv.importProcess(username, name, xpdlNativeType, startCP, startStream.getInputStream(), domain, "", created, lastUpdate);
