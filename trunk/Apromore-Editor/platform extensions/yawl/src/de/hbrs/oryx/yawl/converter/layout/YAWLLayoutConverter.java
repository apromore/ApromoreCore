...
public class YAWLLayoutConverter {
     ...
     *
     * @param specificationString from YAWL XML
     * @param context             in which the layout information will be stored
    ...
    private void setYAWLLocale(Element e) {
    ...
    /**
     * Parse and convert information about the layout of the YAWL nets. These
     * information are stored separate from the decompositions in a YAWL
     * specification.
     *
     * @throws JDOMException
     * @throws IOException
    ...
    /**
     * If the viewport inside YAWL Editor is adjusted, then YAWL stores negative
     * values in "bounds" element. For Oryx this has to be adjusted, simply by
     * setting each negative value to zero!
     *
     * @param boundsElement original "bounds" element of YAWL Net
    ...
    private String fixBoundsAttribute(String attr) {
     ...
     * @param yawlVertex
     */
    private void convertVertexLayout(NetLayout netLayout, Element yawlVertex) {
    ...
    /**
     * Converts the layout of a YAWL condition from a vertex or container
     * element
     *
     * @param netLayout
     * @param yawlContainer may be NULL if the condition has no label
     * @param yawlVertex    containing the bounds of the condition
     */
     ...
     *
     * @param netLayout
     * @param yawlContainer may be NULL if the task has no labels and decorators
     * @param yawlVertex    bounds of the vertex element inside the container
     */
     ...
     */
    private String convertIconPath(Element yawlVertex) {
    ...
    /**
     * Converts the all decorators of a YAWL task. There may be two decorators,
     * each with alignment TOP, LEFT, RIGHT, BOTTOM.
     *
     * @param yawlContainer     the container element of the YAWL task
     * @param layoutInformation already converted layout of the YAWL task
     */
     ...
     * @param yawlFlow
     */
    private void convertFlowLayout(NetLayout netLayout, Element yawlFlow) {
    ...
    /**
     * Return the correct Oryx coordinates for each Decorator-Type and Port
     * combination.
     *
     * @param decoratorType LEFT, RIGHT, TOP, BOTTOM, NONE
     * @param port          integer from 1-14
     * @return
     */
    private Point convertTaskDocker(DecoratorType decoratorType, Integer port) {
     ...
     *
     * @param yawlBounds
     * @param heightAdjusment enlarge the height, without affecting the position
     * @param widthAdjustment enlarge the width, without affecting the position
     * @return
     */
