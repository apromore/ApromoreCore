...
public abstract class OryxDecompositionHandler extends OryxShapeHandler {
     ...
     *
     * @param decomposition parent of the YVariable
     * @param jsonVariable  containing the information
     * @return
     * @throws JSONException
     * @throws ConversionException
     */
     ...
     *
     * @param decomposition parent of the YParameter
     * @param jsonParam     containing the information
     * @return
     * @throws JSONException
     * @throws ConversionException
     */
