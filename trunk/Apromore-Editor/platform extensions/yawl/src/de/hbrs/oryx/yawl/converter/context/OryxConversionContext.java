...
public class OryxConversionContext extends ConversionContext {
     ...
     *
     * @param id            of the YAWL subnet
     * @param subnetDiagram of a YAWL subnet used in the specification to be converted
     */
     ...
     *
     * @param task the Task that cancels the Element
     * @param id   of the Element to be cancelled
     */
