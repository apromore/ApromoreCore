...
public abstract class YAWLUtils {
	...
	static public String elementToString(List<Element> list) {
	 ...
	 */
	public static String convertYawlId(YNet net, BasicShape shape) {
	...
	public static String convertYawlId(BasicShape shape) {
	...
	private static String updateYawlId(BasicShape shape, String uuid) {
