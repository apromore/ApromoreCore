...
public class BPMNSESENormalizer extends BPMNNormalizer {
    ...
    /**
     * Calls normalize method of the {@link de.hpi.bpmn.analysis.BPMNNormalizer} and than starts to
     ...
     *
     * @param process The process to normalize concerning pools
     */
     ...
     * {@link Gateway} type.
     *
     * @param process The process to be normalized by single entry single exit
     */
     ...
     * @return The vector of {@link Gateway}
     */
     ...
     * passed gateway.
     *
     * @param gateway The passed gateway.
     */
     ...
     *
     * @param gateway The gateway to convert
     * @return The converted join gateway
     */
     ...
     *
     * @param gateway The gateway to convert
     * @return The converted split gateway
     */
