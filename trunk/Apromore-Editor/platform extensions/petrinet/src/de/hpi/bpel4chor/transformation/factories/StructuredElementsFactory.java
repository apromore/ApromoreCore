...
public class StructuredElementsFactory {
	 ...
	 * using the {@link de.hpi.bpel4chor.transformation.factories.SequenceFlowFactory}. If the scope content is already a
	 ...
	 * {@link #createMultipleLoop(de.hpi.bpel4chor.model.activities.Task, org.w3c.dom.Element)} or
	 * {@link #createMultipleLoop(de.hpi.bpel4chor.model.activities.BlockActivity, org.w3c.dom.Element)})
	 * 
	 * @param loopingActivity The activity to create the "forEach" element from.
