...
public class DiagramParser {
	 ...
	 * (see {@link SwimlaneParser#parsePool(org.w3c.dom.Node)}. The parsed pool
	 ...
	 * (see {@link SwimlaneParser#parsePoolSet(org.w3c.dom.Node)}. The parsed pool set
	 * is added to the diagram created by this class.
	 * 
	 ...
	 * to an artifact (see {@link ArtifactParser#parseReferenceDataObject(org.w3c.dom.Node, org.w3c.dom.Node)},
	 * {@link ArtifactParser#parseSetDataObject(org.w3c.dom.Node, org.w3c.dom.Node)},
	 * {@link ArtifactParser#parseVariableDataObject(org.w3c.dom.Node, org.w3c.dom.Node)}).
	 * 
	 ...
	 * (see {@link ConnectionsParser#parseMessageFlow(org.w3c.dom.Node)}. The parsed
	 ...
	 * (see {@link ConnectionsParser#parseAssociation(org.w3c.dom.Node)}. The parsed
	 ...
	 * (see {@link ProcessParser#parseProcess(org.w3c.dom.Node)}. The parsed
	 ...
	 * (see {@link #parseAttributes(org.w3c.dom.Element)}, {@link #parseElements(org.w3c.dom.Element)}).
	 * 
	 * @param diagramElement The diagram element to parse.
	 */
