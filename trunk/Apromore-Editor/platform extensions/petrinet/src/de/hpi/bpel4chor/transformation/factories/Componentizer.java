...
public class Componentizer {
	 ...
	 * {@link #computeAttachedErrorEvents(de.hpi.bpel4chor.model.activities.Activity, boolean)}.
	 * 
	 * @param quasi True, if the pattern searched for is a quasi pattern,
	 * 				false otherwise.
	 * 
	 ...
	 * the method {@link #computeSequenceActivities(de.hpi.bpel4chor.model.activities.Activity)}. After that the
