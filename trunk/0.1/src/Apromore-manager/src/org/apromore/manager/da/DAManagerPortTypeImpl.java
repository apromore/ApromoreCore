...
public class DAManagerPortTypeImpl implements DAManagerPortType {
    ...
    public org.apromore.manager.model_da.UpdateProcessSummariesOutputMsgType updateProcessSummaries(org.apromore.manager.model_da.UpdateProcessSummariesInputMsgType payload) { 
        LOG.info("Executing operation updateProcessSummaries");
        System.out.println(payload);
        try {
            org.apromore.manager.model_da.UpdateProcessSummariesOutputMsgType _return = new org.apromore.manager.model_da.UpdateProcessSummariesOutputMsgType();
            org.apromore.manager.model_da.ResultType _returnResult = new org.apromore.manager.model_da.ResultType();
            _returnResult.setMessage("Message1307927612");
            _returnResult.setCode(Integer.valueOf(-240684387));
            _return.setResult(_returnResult);
            return _return;
        } catch (Exception ex) {
            ex.printStackTrace();
