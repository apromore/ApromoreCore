...
public class TestCanonical2XPDL {
	...
	public static void main(String[] args) {
		File cpf_file = new File("EPML_models/role_2.cpf");
		File anf_file = new File("EPML_models/role_2.anf");
