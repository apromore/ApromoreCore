...
public class TestEPML2Canonical {
	...
	public static void main(String[] args) {
		...
		File file = new File("/home/fauvet/models/epml/Audio.epml");
		...
		try {
			...
			m.marshal(cprocRootElem, new File ("/home/fauvet/models/epml/Audio.cpf"));
			...
			m.marshal(annsRootElem, new File ("/home/fauvet/models/epml/Audio.anf"));
