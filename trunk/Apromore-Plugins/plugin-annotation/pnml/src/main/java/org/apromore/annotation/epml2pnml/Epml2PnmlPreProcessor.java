package org.apromore.annotation.epml2pnml;
...
/**
 * EPML to PNML Post Processor.
 * Used to manipulate the ANF of the EPML output when the input process langauge was PNML.
 * Used to change the size of the shapes as each language has different sizes elements.
 *
 * @author <a href="mailto:cam.james@gmail.com">Cameron James</a>
 */
@Component("epml2pnmlPreAnnotationProcessor")
public class Epml2PnmlPreProcessor extends DefaultAbstractAnnotationProcessor {
