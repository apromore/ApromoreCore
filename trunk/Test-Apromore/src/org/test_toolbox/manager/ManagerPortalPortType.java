...
public interface ManagerPortalPortType {
    ...
    public org.test_toolbox.manager.model_manager.WriteUserOutputMsgType writeUser(
        @WebParam(partName = "payload", name = "WriteUserInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.WriteUserInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.EditProcessDataOutputMsgType editProcessData(
        @WebParam(partName = "payload", name = "EditProcessDataInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.EditProcessDataInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.WriteEditSessionOutputMsgType writeEditSession(
        @WebParam(partName = "payload", name = "WriteEditSessionInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.WriteEditSessionInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.ExportFormatOutputMsgType exportFormat(
        @WebParam(partName = "payload", name = "ExportFormatInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.ExportFormatInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.ReadNativeTypesOutputMsgType readNativeTypes(
        @WebParam(partName = "payload", name = "ReadNativeTypesInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.ReadNativeTypesInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.ReadDomainsOutputMsgType readDomains(
        @WebParam(partName = "payload", name = "ReadDomainsInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.ReadDomainsInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.MergeProcessesOutputMsgType mergeProcesses(
        @WebParam(partName = "payload", name = "MergeProcessesInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.MergeProcessesInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.ReadUserOutputMsgType readUser(
        @WebParam(partName = "payload", name = "ReadUserInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.ReadUserInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.WriteAnnotationOutputMsgType writeAnnotation(
        @WebParam(partName = "payload", name = "WriteAnnotationInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.WriteAnnotationInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.ReadAllUsersOutputMsgType readAllUsers(
        @WebParam(partName = "payload", name = "ReadAllUsersInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.ReadAllUsersInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.DeleteEditSessionOutputMsgType deleteEditSession(
        @WebParam(partName = "payload", name = "DeleteEditSessionInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.DeleteEditSessionInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.SearchForSimilarProcessesOutputMsgType searchForSimilarProcesses(
        ...
        org.test_toolbox.manager.model_manager.SearchForSimilarProcessesInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.DeleteProcessVersionsOutputMsgType deleteProcessVersions(
        @WebParam(partName = "payload", name = "DeleteProcessVersionsInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.DeleteProcessVersionsInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.ImportProcessOutputMsgType importProcess(
        @WebParam(partName = "payload", name = "ImportProcessInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.ImportProcessInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.ReadProcessSummariesOutputMsgType readProcessSummaries(
        @WebParam(partName = "payload", name = "ReadProcessSummariesInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.ReadProcessSummariesInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.ReadEditSessionOutputMsgType readEditSession(
        @WebParam(partName = "payload", name = "ReadEditSessionInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.ReadEditSessionInputMsgType payload
    );
    ...
    public org.test_toolbox.manager.model_manager.UpdateProcessOutputMsgType updateProcess(
        @WebParam(partName = "payload", name = "UpdateProcessInputMsg", targetNamespace = "http://www.apromore.org/manager/model_portal")
        org.test_toolbox.manager.model_manager.UpdateProcessInputMsgType payload
    );
}
