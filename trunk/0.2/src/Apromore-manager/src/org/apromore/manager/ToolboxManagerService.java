...
public class ToolboxManagerService extends Service {
    ...
    static {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ToolboxManagerService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/Apromore-toolbox/services/ToolboxManager?wsdl");
        }
        WSDL_LOCATION = url;
    }
